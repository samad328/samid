...
function martin(){
    var q = {
        ...
        overwrite: !1,
        delay: 0
    }, qt, _e = 1e8, D = 1 / _e, Qt = Math.PI * 2, Sr = Qt / 4, Cr = 0, Yi = Math.sqrt, Mr = Math.cos, Er = Math.sin, j = s=>typeof s == "string", W = s=>typeof s == "function", ue = s=>typeof s == "number", bt = s=>typeof s == "undefined", Te = s=>typeof s == "object", Z = s=>s !== !1, qi = ()=>typeof window != "undefined", Qi = s=>W(s) || j(s), Zi = typeof ArrayBuffer == "function" && ArrayBuffer.isView || function() {}
    , ne = Array.isArray, Zt = /(?:-?\.?\d|\.)+/gi, Kt = /[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g, Be = /[-+=.]*\d+[.e-]*\d*[a-z%]*/g, Jt = /[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi, $t = /[+-]=-?[.\d]+/, Ki = /[#\-+.]*\b[a-z\d-=+%.]+/gi, Dr = /[\d.+\-=]+(?:e[-+]\d*)*/i, B, me, ei, Ji, te = {}, wt = {}, $i, es = s=>(wt = Qe(s, te)) && oe, Tt = (s,e)=>console.warn("Invalid property", s, "set to", e, "Missing plugin? gsap.registerPlugin()"), ts = (s,e)=>!e && console.warn(s), is = (s,e)=>s && (te[s] = e) && wt && (wt[s] = e) || te, lt = ()=>0, ti = {}, Me = [], ii = {}, ss, K = {}, si = {}, rs = 30, Pt = [], ri = "", ai = s=>{
        let e = s[0], t, i;
        if (Te(e) || W(e) || (s = [s]),
        !(t = (e._gsap || {}).harness)) {
    ...
    , Ee = s=>s._gsap || ai(xe(s))[0]._gsap, ni = (s,e,t)=>(t = s[e]) && W(t) ? s[e]() : bt(t) && s.getAttribute && s.getAttribute(e) || t, J = (s,e)=>(s = s.split(",")).forEach(e) || s, S = s=>Math.round(s * 1e5) / 1e5 || 0, Lr = (s,e)=>{
        let t = e.length
          , i = 0;
    ...
    , dt = (s,e,t)=>{
        let i = ue(s[1]), r = (i ? 2 : 1) + (e < 2 ? 0 : 1), a = s[r], n;
        if (i && (a.duration = s[1]),
        a.parent = t,
        e) {
            for (n = a; t && !("immediateRender"in n); )
                n = t.vars.defaults || {},
                t = Z(t.vars.inherit) && t.parent;
    ...
    , St = ()=>{
        let s = Me.length, e = Me.slice(0), t, i;
        for (ii = {},
        Me.length = 0,
        t = 0; t < s; t++)
            i = e[t],
    ...
    , Ar = (s,e)=>{
        for (let t in e)
            t in s || t === "duration" || t === "ease" || (s[t] = e[t])
    }
    , Qe = (s,e)=>{
        for (let t in e)
            s[t] = e[t];
    ...
    , oi = (s,e)=>{
        for (let t in e)
            t !== "__proto__" && t !== "constructor" && t !== "prototype" && (s[t] = Te(e[t]) ? oi(s[t] || (s[t] = {}), e[t]) : e[t]);
        return s
    }
    , hi = (s,e)=>{
        let t = {}, i;
    ...
    , De = (s,e)=>{
        s.parent && (!e || s.parent.autoRemoveChildren) && s.parent.remove(s),
        s._act = 0
    }
    , Ne = (s,e)=>{
    ...
    , hs = s=>!s || s._ts && hs(s.parent), ls = s=>s._repeat ? Ze(s._tTime, s = s.duration() + s._rDelay) * s : 0, Ze = (s,e)=>{
        let t = Math.floor(s /= e);
        return s && t === s ? t - 1 : t
    }
    , Et = (s,e)=>(s - e._start) * e._ts + (e._ts >= 0 ? 0 : e._dirty ? e.totalDuration() : e._tDur), li = s=>s._end = S(s._start + (s._tDur / Math.abs(s._ts || s._rts || D) || 0)), ds = (s,e)=>{
        let t = s._dp;
        return t && t.smoothChildTiming && s._ts && (s._start = S(t._time - (s._ts > 0 ? e / s._ts : ((s._dirty ? s.totalDuration() : s._tDur) - e) / -s._ts)),
        li(s),
        t._dirty || Ne(t, s)),
        s
    }
    , Dt = (s,e)=>{
        let t;
        if ((e._time || e._initted && !e._dur) && (t = Et(s.rawTime(), e),
    ...
    , Pe = (s,e,t,i)=>(e.parent && De(e),
    e._start = S(t + e._delay),
    e._end = S(e._start + (e.totalDuration() / Math.abs(e.timeScale()) || 0)),
    Or(s, e, "_first", "_last", s._sort ? "_start" : 0),
    s._recent = e,
    i || Dt(s, e),
    s), us = (s,e)=>(te.ScrollTrigger || Tt("scrollTrigger", e)) && te.ScrollTrigger.create(e, s), fs = (s,e,t,i)=>{
        if (cs(s, e),
        !s._initted)
            return 1;
        if (!t && s._pt && (s._dur && s.vars.lazy !== !1 || !s._dur && s.vars.lazy) && ss !== ie.frame)
            return Me.push(s),
            s._lazy = [e, i],
            1
    }
    , ps = ({parent: s})=>s && s._ts && s._initted && !s._lock && (s.rawTime() < 0 || ps(s)), Vr = (s,e,t,i)=>{
        let r = s.ratio, a = e < 0 || !e && (!s._start && ps(s) || (s._ts < 0 || s._dp._ts < 0) && s.data !== "isFromStart" && s.data !== "isStart") ? 0 : 1, n = s._rDelay, o = 0, l, h, d;
        if (n && s._repeat && (o = ut(0, s._tDur, e),
        h = Ze(o, n),
        d = Ze(s._tTime, n),
        s._yoyo && h & 1 && (a = 1 - a),
        h !== d && (r = 1 - a,
        s.vars.repeatRefresh && s._initted && s.invalidate())),
        a !== r || i || s._zTime === D || !e && s._zTime) {
            if (!s._initted && fs(s, e, i, t))
                return;
            for (d = s._zTime,
            s._zTime = e || (t ? D : 0),
            t || (t = e && !d),
            ...
            (e >= s._tDur || e < 0) && s.ratio === a && (a && De(s, 1),
            t || (se(s, a ? "onComplete" : "onReverseComplete", !0),
            s._prom && s._prom()))
        } else
            s._zTime || (s._zTime = e)
    }
    ...
    , gs = s=>s instanceof G ? Ne(s) : Ke(s, s._dur), Ir = {
        _start: 0,
        endTime: lt
    }, H = (s,e)=>{
        let t = s.labels, i = s._recent || Ir, r = s.duration() >= _e ? i.endTime(!1) : s._dur, a, n;
        return j(e) && (isNaN(e) || e in t) ? (a = e.charAt(0),
        a === "<" || a === ">" ? (a === "<" ? i._start : i.endTime(i._repeat >= 0)) + (parseFloat(e.substr(1)) || 0) : (a = e.indexOf("="),
        a < 0 ? (e in t || (t[e] = r),
        t[e]) : (n = +(e.charAt(a - 1) + e.substr(a + 1)),
        a > 1 ? H(s, e.substr(0, a - 1)) + n : r + n))) : e == null ? r : +e
    }
    , Le = (s,e)=>s || s === 0 ? e(s) : e, ut = (s,e,t)=>t < s ? s : t > e ? e : t, $ = s=>{
        if (typeof s != "string")
            return "";
        let e = Dr.exec(s);
        return e ? s.substr(e.index + e[0].length) : ""
    }
    , Ur = (s,e,t)=>Le(t, i=>ut(s, e, i)), di = [].slice, _s = (s,e)=>s && Te(s) && "length"in s && (!e && !s.length || s.length - 1 in s && Te(s[0])) && !s.nodeType && s !== me, Br = (s,e,t=[])=>s.forEach(i=>j(i) && !e || _s(i, 1) ? t.push(...xe(i)) : t.push(i)) || t, xe = (s,e)=>j(s) && !e && (ei || !Je()) ? di.call(Ji.querySelectorAll(s), 0) : ne(s) ? Br(s, e) : _s(s) ? di.call(s, 0) : s ? [s] : [], ms = s=>s.sort(()=>.5 - Math.random()), ys = s=>{
        if (W(s))
            return s;
        let e = Te(s) ? s : {
            each: s
        ...
        d = i[1]),
        (c,p,f)=>{
            let u = (f || e).length, g = a[u], _, v, x, T, m, y, w, b, P;
            if (!g) {
                if (P = e.grid === "auto" ? 0 : (e.grid || [1, _e])[1],
                !P) {
                ...
                g.max = w - b,
                g.min = b,
                g.v = u = (parseFloat(e.amount) || parseFloat(e.each) * (P > u ? u - 1 : l ? l === "y" ? u / P : P : Math.max(P, u / P)) || 0) * (i === "edges" ? -1 : 1),
                g.b = u < 0 ? r - u : r,
                g.u = $(e.amount || e.each) || 0,
                t = t && u < 0 ? xs(t) : t
            }
            return u = (g[c] - g.min) / g.max || 0,
            S(g.b + (t ? t(u) : u) * g.v) + g.u
        }
    }
    , ui = s=>{
    ...
    , vs = (s,e)=>{
        let t = ne(s), i, r;
        return !t && Te(s) && (i = t = s.radius || _e,
        s.values ? (s = xe(s.values),
        (r = !ue(s[0])) && (i *= i)) : s = ui(s.increment)),
        Le(e, t ? W(s) ? a=>(r = s(a),
        Math.abs(r - a) <= i ? r : a) : a=>{
            let n = parseFloat(r ? a.x : a), o = parseFloat(r ? a.y : 0), l = _e, h = 0, d = s.length, c, p;
            for (; d--; )
                r ? (c = s[d].x - n,
                p = s[d].y - o,
                c = c * c + p * p) : c = Math.abs(s[d] - n),
                c < l && (l = c,
                h = d);
            return h = !i || l <= i ? s[h] : a,
            r || h === a || ue(a) ? h : h + $(a)
        }
        : ui(s))
    }
    , bs = (s,e,t,i)=>Le(ne(s) ? !e : t === !0 ? !!(t = 0) : !i, ()=>ne(s) ? s[~~(Math.random() * s.length)] : (t = t || 1e-5) && (i = t < 1 ? 10 ** ((t + "").length - 2) : 1) && Math.floor(Math.round((s - t / 2 + Math.random() * (e - s + t * .99)) / t) * t * i) / i), Nr = (...s)=>e=>s.reduce((t,i)=>i(t), e), Wr = (s,e)=>t=>s(parseFloat(t)) + (e || $(t)), jr = (s,e,t)=>ws(s, e, 0, 1, t), Ts = (s,e,t)=>Le(t, i=>s[~~e(i)]), Ps = function(s, e, t) {
        let i = e - s;
        return ne(s) ? Ts(s, Ps(0, s.length), e) : Le(t, r=>(i + (r - s) % i) % i + s)
    }, Rs = (s,e,t)=>{
        let i = e - s
          , r = i * 2;
        return ne(s) ? Ts(s, Rs(0, s.length - 1), e) : Le(t, a=>(a = (r + (a - s) % r) % r || 0,
        s + (a > i ? r - a : a)))
    }
    , ct = s=>{
        let e = 0, t = "", i, r, a, n;
    ...
    , Cs = (s,e,t)=>{
        let i = s.labels, r = _e, a, n, o;
        for (a in i)
            n = i[a] - e,
            n < 0 == !!t && n && r > (n = Math.abs(n)) && (o = a,
            r = n);
        return o
    }
    , se = (s,e,t)=>{
        let i = s.vars, r = i[e], a, n;
        if (!!r)
            return a = i[e + "Params"],
            n = i.callbackScope || s,
            t && Me.length && St(),
    ...
    , ft = s=>(De(s),
    s.progress() < 1 && se(s, "onInterrupt"),
    s), et, Xr = s=>{
        s = !s.name && s.default || s;
        let e = s.name
          , t = W(s)
          , i = e && !t && s.init ? function() {
            this._props = []
        }
        : s
          , r = {
    ...
    , O = 255, pt = {
        ...
        cyan: [0, O, O],
        transparent: [O, O, O, 0]
    }, pi = (s,e,t)=>(s = s < 0 ? s + 1 : s > 1 ? s - 1 : s,
    (s * 6 < 1 ? e + (t - e) * s * 6 : s < .5 ? t : s * 3 < 2 ? e + (t - e) * (2 / 3 - s) * 6 : e) * O + .5 | 0), Ms = (s,e,t)=>{
        let i = s ? ue(s) ? [s >> 16, s >> 8 & O, s & O] : 0 : pt.black, r, a, n, o, l, h, d, c, p, f;
        if (!i) {
            if (s.substr(-1) === "," && (s = s.substr(0, s.length - 1)),
            pt[s])
                i = pt[s];
            else if (s.charAt(0) === "#") {
                if (s.length < 6 && (r = s.charAt(1),
                a = s.charAt(2),
                n = s.charAt(3),
                s = "#" + r + r + a + a + n + n + (s.length === 5 ? s.charAt(4) + s.charAt(4) : "")),
                s.length === 9)
                    return i = parseInt(s.substr(1, 6), 16),
                    [i >> 16, i >> 8 & O, i & O, parseInt(s.substr(7), 16) / 255];
                s = parseInt(s.substr(1), 16),
                i = [s >> 16, s >> 8 & O, s & O]
        ...
        d === c ? o = l = 0 : (p = d - c,
        l = h > .5 ? p / (2 - d - c) : p / (d + c),
        o = d === r ? (a - n) / p + (a < n ? 6 : 0) : d === a ? (n - r) / p + 2 : (r - a) / p + 4,
        o *= 60),
        i[0] = ~~(o + .5),
        i[1] = ~~(l * 100 + .5),
        i[2] = ~~(h * 100 + .5)),
    ...
    , Ds = (s,e,t)=>{
        let i = "", r = (s + i).match(tt), a = e ? "hsla(" : "rgba(", n = 0, o, l, h, d;
        if (!r)
            return s;
        if (r = r.map(c=>(c = Ms(c, e, 1)) && a + (e ? c[0] + "," + c[1] + "%," + c[2] + "%," + c[3] : c.join(",")) + ")"),
        t && (h = Es(s),
        o = t.c,
        o.join(i) !== h.c.join(i)))
            for (l = s.replace(tt, "1").split(Be),
            d = l.length - 1; n < d; n++)
                i += l[n] + (~o.indexOf(n) ? r.shift() || a + "0,0,0,0)" : (h.length ? h : r.length ? r : t).shift());
        if (!l)
            for (l = s.split(tt),
            d = l.length - 1; n < d; n++)
                i += l[n] + r[n];
    ...
    , tt = function() {
        let s = "(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b", e;
        for (e in pt)
            s += "|" + e + "\\b";
    ...
    , At, ie = function() {
        let s = Date.now, e = 500, t = 33, i = s(), r = i, a = 1e3 / 240, n = a, o = [], l, h, d, c, p, f, u = g=>{
            let _ = s() - r, v = g === !0, x, T, m, y;
            if (_ > e && (i += _ - t),
            r += _,
            m = r - i,
            x = m - n,
        ...
        c
    }(), Je = ()=>!At && ie.wake(), Y = {}, qr = /^[\d.\-M][\d.\-,\s]/, Qr = /["']/g, Zr = s=>{
        let e = {}, t = s.substr(1, s.length - 3).split(":"), i = t[0], r = 1, a = t.length, n, o, l;
        for (; r < a; r++)
            o = t[r],
    ...
    , Jr = s=>{
        let e = (s + "").split("(")
          , t = Y[e[0]];
        return t && e.length > 1 && t.config ? t.config.apply(null, ~s.indexOf("{") ? [Zr(e[1])] : Kr(s).split(",").map(ns)) : Y._CE && qr.test(s) ? Y._CE("", s) : t
    }
    , xs = s=>e=>1 - s(1 - e), kt = (s,e)=>{
        let t = s._first, i;
        for (; t; )
            t instanceof G ? kt(t, e) : t.vars.yoyoEase && (!t._yoyo || !t._repeat) && t._yoyo !== e && (t.timeline ? kt(t.timeline, e) : (i = t._ease,
            t._ease = t._yEase,
            t._yEase = i,
            t._yoyo = e)),
            t = t._next
    }
    , $e = (s,e)=>s && (W(s) ? s : Y[s] || Jr(s)) || e, We = (s,e,t=r=>1 - e(1 - r),i=r=>r < .5 ? e(r * 2) / 2 : 1 - e((1 - r) * 2) / 2)=>{
        let r = {
            easeIn: e,
            easeOut: t,
            easeInOut: i
        ...
        return J(s, n=>{
            ...
            Y[a = n.toLowerCase()] = t;
            for (let o in r)
                Y[a + (o === "easeIn" ? ".in" : o === "easeOut" ? ".out" : ".inOut")] = Y[n + "." + o] = r[o]
        }
        ),
        r
    }
    , Ls = s=>e=>e < .5 ? (1 - s(1 - e * 2)) / 2 : .5 + s((e - .5) * 2) / 2, Ot = (s,e,t)=>{
        let i = e >= 1 ? e : 1
          , r = (t || (s ? .3 : .45)) / (e < 1 ? e : 1)
        ...
        return r = Qt / r,
        o.config = (l,h)=>Ot(s, l, h),
        o
    }
    , Ft = (s,e=1.70158)=>{
        let t = r=>r ? --r * r * ((e + 1) * r + e) + 1 : 0
          , i = s === "out" ? t : s === "in" ? r=>1 - t(1 - r) : Ls(t);
        return i.config = r=>Ft(s, r),
        i
    }
    ;
    J("Linear,Quad,Cubic,Quart,Quint,Strong", (s,e)=>{
        let t = e < 5 ? e + 1 : e;
        We(s + ",Power" + (t - 1), e ? i=>i ** t : i=>i, i=>1 - (1 - i) ** t, i=>i < .5 ? (i * 2) ** t / 2 : 1 - ((1 - i) * 2) ** t / 2)
    }
    );
    ...
    ((s,e)=>{
        let t = 1 / e
          , i = 2 * t
          , r = 2.5 * t
          , a = n=>n < t ? s * n * n : n < i ? s * (n - 1.5 / e) ** 2 + .75 : n < r ? s * (n -= 2.25 / e) * n + .9375 : s * (n - 2.625 / e) ** 2 + .984375;
    ...
    Y.SteppedEase = Y.steps = te.SteppedEase = {
        config(s=1, e) {
            let t = 1 / s
              , i = s + (e ? 0 : 1)
              , r = e ? 1 : 0
    ...
    qe.ease = Y["quad.out"];
    J("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt", s=>ri += s + "," + s + "Params,");
    var Rt = class {
        constructor(e, t) {
            this.id = Cr++,
            e._gsap = this,
      ...
      , it = class {
        constructor(e, t) {
            ...
            (this._repeat = e.repeat === Infinity ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0,
        ...
        totalDuration(e) {
            ...
            Ke(this, this._repeat < 0 ? e : (e - this._repeat * this._rDelay) / (this._repeat + 1))) : this._tDur
        }
        totalTime(e, t) {
            if (Je(),
            !arguments.length)
            ...
            if (i && i.smoothChildTiming && this._ts) {
                for (ds(this, e),
                !i._dp || i.parent || Dt(i, this); i.parent; )
            ...
            return (this._tTime !== e || !this._dur && !t || this._initted && Math.abs(this._zTime) === D || !e && !this._initted && (this.add || this._ptLookup)) && (this._ts || (this._pTime = e),
            as(this, e, t)),
            this
        }
        time(e, t) {
            return arguments.length ? this.totalTime(Math.min(this.totalDuration(), e + ls(this)) % this._dur || (e ? this._dur : 0), t) : this._time
        }
        totalProgress(e, t) {
            return arguments.length ? this.totalTime(this.totalDuration() * e, t) : this.totalDuration() ? Math.min(1, this._tTime / this._tDur) : this.ratio
        }
        progress(e, t) {
            return arguments.length ? this.totalTime(this.duration() * (this._yoyo && !(this.iteration() & 1) ? 1 - e : e) + ls(this), t) : this.duration() ? Math.min(1, this._time / this._dur) : this.ratio
        }
        iteration(e, t) {
            let i = this.duration() + this._rDelay;
            return arguments.length ? this.totalTime(this._time + (e - 1) * i, t) : this._repeat ? Ze(this._tTime, i) + 1 : 1
        }
        timeScale(e) {
            if (!arguments.length)
        ...
        paused(e) {
            ...
            this._ts = this._rts,
            this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, this.progress() === 1 && (this._tTime -= D) && Math.abs(this._zTime) !== D))),
            this) : this._ps
        }
        startTime(e) {
            if (arguments.length) {
                ...
                return t && (t._sort || !this.parent) && Pe(t, this, e - this._delay),
                this
            }
            return this._start
        }
        ...
        repeat(e) {
            return arguments.length ? (this._repeat = e === Infinity ? -2 : e,
            gs(this)) : this._repeat === -2 ? Infinity : this._repeat
        }
        repeatDelay(e) {
            return arguments.length ? (this._rDelay = e,
            gs(this)) : this._rDelay
        }
        yoyo(e) {
        ...
        reversed(e) {
            return arguments.length ? (!!e !== this.reversed() && this.timeScale(-this._rts || (e ? -D : 0)),
            this) : this._rts < 0
        }
        invalidate() {
        ...
        isActive() {
            let e = this.parent || this._dp, t = this._start, i;
            return !!(!e || this._ts && this._initted && e.isActive() && (i = e.rawTime(!0)) >= t && i < this.endTime(!0) - D)
        }
        eventCallback(e, t, i) {
            let r = this.vars;
    ...
    var G = class extends it {
        ...
        to(e, t, i) {
            return new L(e,dt(arguments, 0, this),H(this, ue(t) ? arguments[3] : i)),
            this
        }
        from(e, t, i) {
            return new L(e,dt(arguments, 1, this),H(this, ue(t) ? arguments[3] : i)),
            this
        }
        fromTo(e, t, i, r) {
            return new L(e,dt(arguments, 2, this),H(this, ue(t) ? arguments[4] : r)),
            this
        }
        set(e, t, i) {
            return t.duration = 0,
        ...
        render(e, t, i) {
            let r = this._time, a = this._dirty ? this.totalDuration() : this._tDur, n = this._dur, o = this !== B && e > a - D && e >= 0 ? a : e < D ? 0 : e, l = this._zTime < 0 != e < 0 && (this._initted || !n), h, d, c, p, f, u, g, _, v, x, T, m;
            if (o !== this._tTime || i || l) {
                if (r !== this._time && n && (o += this._time - r,
                e += this._time - r),
                h = o,
                v = this._start,
                _ = this._ts,
                ...
                if (this._hasPause && !this._forcing && this._lock < 2 && (g = zr(this, S(r), S(h)),
                g && (o -= h - (h = g._start))),
                this._tTime = o,
                this._time = h,
                this._act = !_,
                ...
                h >= r && e >= 0)
                    for (d = this._first; d; ) {
                        if (c = d._next,
                        (d._act || h >= d._start) && d._ts && g !== d) {
                            if (d.parent !== this)
                                return this.render(e, t, i);
                            if (d.render(d._ts > 0 ? (h - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (h - d._start) * d._ts, t, i),
                    ...
                    for (; d; ) {
                        if (c = d._prev,
                        (d._act || y <= d._end) && d._ts && g !== d) {
                            if (d.parent !== this)
                                return this.render(e, t, i);
                            if (d.render(d._ts > 0 ? (y - d._start) * d._ts : (d._dirty ? d.totalDuration() : d._tDur) + (y - d._start) * d._ts, t, i),
                            h !== this._time || !this._ts && !u) {
                                g = 0,
                                c && (o += this._zTime = y ? -D : D);
                                break
                            }
                        }
                        d = c
                ...
                if (g && !t && (this.pause(),
                g.render(h >= r ? 0 : -D)._zTime = h >= r ? 1 : -1,
                this._ts))
                    return this._start = v,
                    li(this),
                    this.render(e, t, i);
                this._onUpdate && !t && se(this, "onUpdate", !0),
                (o === a && a >= this.totalDuration() || !o && r) && (v === this._start || Math.abs(_) !== Math.abs(this._ts)) && (this._lock || ((e || !n) && (o === a && this._ts > 0 || !o && this._ts < 0) && De(this, 1),
                !t && !(e < 0 && !r) && (o || r) && (se(this, o === a ? "onComplete" : "onReverseComplete", !0),
        ...
        add(e, t) {
            ...
            !(e instanceof it)) {
                if (ne(e))
                    return e.forEach(i=>this.add(i, t)),
                    this;
                if (j(e))
        ...
        getChildren(e=!0, t=!0, i=!0, r=-_e) {
            let a = []
              , n = this._first;
            for (; n; )
                n._start >= r && (n instanceof L ? t && a.push(n) : (i && a.push(n),
                e && a.push(...n.getChildren(!0, t, i)))),
                n = n._next;
            return a
        }
        getById(e) {
        ...
        remove(e) {
            return j(e) ? this.removeLabel(e) : W(e) ? this.killTweensOf(e) : (Mt(this, e),
            e === this._recent && (this._recent = this._last),
            Ne(this))
        }
        totalTime(e, t) {
            return arguments.length ? (this._forcing = 1,
            !this._dp && this._ts && (this._start = S(ie.time - (this._ts > 0 ? e / this._ts : (this.totalDuration() - e) / -this._ts))),
            super.totalTime(e, t),
            this._forcing = 0,
            this) : this._tTime
        }
        addLabel(e, t) {
            return this.labels[e] = H(this, t),
            this
        }
        removeLabel(e) {
        ...
        removePause(e) {
            let t = this._first;
            for (e = H(this, e); t; )
                t._start === e && t.data === "isPause" && De(t),
                t = t._next
        }
        killTweensOf(e, t, i) {
        ...
        getTweensOf(e, t) {
            let i = [], r = xe(e), a = this._first, n = ue(t), o;
            for (; a; )
                a instanceof L ? Lr(a._targets, r) && (n ? (!Ae || a._initted && a._ts) && a.globalTime(0) <= t && a.globalTime(a.totalDuration()) > t : !t || a.isActive()) && i.push(a) : (o = a.getTweensOf(r, t)).length && i.push(...o),
                a = a._next;
            return i
        }
        tweenTo(e, t) {
            ...
            let i = this
              ...
              , h = L.to(i, he({
                ...
                time: r,
                overwrite: "auto",
                duration: t.duration || Math.abs((r - (a && "time"in a ? a.time : i._time)) / i.timeScale()) || D,
                onStart: ()=>{
                    i.pause();
                    let d = t.duration || Math.abs((r - i._time) / i.timeScale());
                    h._dur !== d && Ke(h, d, 0, 1).render(h._time, !0, !0),
                    n && n.apply(h, o || [])
                }
            }, t));
        ...
        shiftChildren(e, t, i=0) {
            let r = this._first, a = this.labels, n;
            for (; r; )
        ...
        totalDuration(e) {
            let t = 0, i = this, r = i._last, a = _e, n, o, l;
            if (arguments.length)
            ...
            if (i._dirty) {
                for (l = i.parent; r; )
                    ...
                    o = r._start,
                    o > a && i._sort && r._ts && !i._lock ? (i._lock = 1,
                    Pe(i, r, o - r._delay, 1)._lock = 0) : a = o,
                    o < 0 && r._ts && (t -= o,
                    (!l && !i._dp || l && l.smoothChildTiming) && (i._start += o / i._ts,
                    i._time -= o,
                    i._tTime -= o),
                    ...
                    r = n;
                Ke(i, i === B && i._time > t ? i._time : t, 1, 1),
                i._dirty = 0
            }
            return i._tDur
        }
        static updateRoot(e) {
            if (B._ts && (as(B, Et(e, B)),
            ss = ie.frame),
            ie.frame >= rs) {
                rs += q.autoSleep || 120;
                let t = B._first;
    ...
    var $r = function(s, e, t, i, r, a, n) {
        let o = new X(this._pt,s,e,0,1,_i,null,r), l = 0, h = 0, d, c, p, f, u, g, _, v;
        for (o.b = t,
        o.e = i,
        t += "",
        i += "",
        ...
        t = v[0],
        i = v[1]),
        c = t.match(Jt) || []; d = Jt.exec(i); )
            f = d[0],
            u = i.substring(l, d.index),
            p ? p = (p + 1) % 5 : u.substr(-5) === "rgba(" && (p = 1),
            f !== c[h++] && (g = parseFloat(c[h - 1]) || 0,
            o._pt = {
                _next: o._pt,
                p: u || h === 1 ? u : ",",
                s: g,
                c: f.charAt(1) === "=" ? parseFloat(f.substr(2)) * (f.charAt(0) === "-" ? -1 : 1) : parseFloat(f) - g,
                m: p && p < 4 ? Math.round : 0
            },
            l = Jt.lastIndex);
        return o.c = l < i.length ? i.substring(l, i.length) : "",
        o.fp = n,
        ($t.test(i) || _) && (o.e = 0),
        this._pt = o,
        o
        ...
        W(i) && (i = i(r || 0, s, a));
        let h = s[e], d = t !== "get" ? t : W(h) ? l ? s[e.indexOf("set") || !W(s["get" + e.substr(3)]) ? e : "get" + e.substr(3)](l) : s[e]() : h, c = W(h) ? l ? ea : As : mi, p;
        if (j(i) && (~i.indexOf("random(") && (i = ct(i)),
        i.charAt(1) === "=" && (i = parseFloat(d) + parseFloat(i.substr(2)) * (i.charAt(0) === "-" ? -1 : 1) + ($(d) || 0))),
        d !== i)
            return isNaN(d * i) ? (!h && !(e in s) && Tt(e, i),
            $r.call(this, s, e, d, i, c, o || q.stringFilter, l)) : (p = new X(this._pt,s,e,+d || 0,i - (d || 0),typeof h == "boolean" ? ta : ks,0,c),
            l && (p.fp = l),
            n && p.modifier(n, this, s),
            this._pt = p)
    }, ia = (s,e,t,i,r)=>{
        if (W(s) && (s = gt(s, r, e, t, i)),
        !Te(s) || s.style && s.nodeType || ne(s) || Zi(s))
    ...
    , xi = (s,e,t,i,r,a)=>{
        let n, o, l, h;
        if (K[s] && (n = new K[s]).init(r, n.rawVars ? e[s] : ia(e[s], i, r, a, t), t, i, a) !== !1 && (t._pt = o = new X(t._pt,r,s,0,1,n.render,n,0,n.priority),
        t !== et))
            for (l = t._ptLookup[t._targets.indexOf(r)],
            h = n._props.length; h--; )
                l[n._props[h]] = o;
        return n
    }
    , Ae, cs = (s,e)=>{
        let t = s.vars, {ease: i, startAt: r, immediateRender: a, lazy: n, onUpdate: o, onUpdateParams: l, callbackScope: h, runBackwards: d, yoyoEase: c, keyframes: p, autoRevert: f} = t, u = s._dur, g = s._startAt, _ = s._targets, v = s.parent, x = v && v.data === "nested" ? v.parent._targets : _, T = s._overwrite === "auto" && !qt, m = s.timeline, y, w, b, P, C, E, F, I, k, U, V, M, fe;
        if (m && (!p || !i) && (i = "none"),
        s._ease = $e(i, qe.ease),
        s._yEase = c ? xs($e(c === !0 ? i : c, qe.ease)) : 0,
        c && s._yoyo && !s._repeat && (c = s._yEase,
        s._yEase = s._ease,
        s._ease = c),
        !m) {
            if (I = _[0] ? Ee(_[0]).harness : 0,
            M = I && t[I.prop],
            y = hi(t, ti),
            g && g.render(-1, !0).kill(),
            r) {
                if (De(s._startAt = L.set(_, he({
                    data: "isStart",
                    overwrite: !1,
                    parent: v,
                    immediateRender: !0,
            ...
            w = 0; w < _.length; w++) {
                ...
                V = x === _ ? w : x.indexOf(C),
                I && (k = new I).init(C, M || y, s, V, x) !== !1 && (s._pt = P = new X(s._pt,C,k.name,0,1,k.render,k,0,k.priority),
                k._props.forEach(pe=>{
                    U[pe] = P
                }
                ),
                ...
                !I || M)
                    for (b in y)
                        K[b] && (k = xi(b, y, s, V, C, x)) ? k.priority && (E = 1) : U[b] = P = ci.call(s, C, b, "get", y[b], V, x, 0, t.stringFilter);
                s._op && s._op[w] && s.kill(C, s._op[w]),
                T && s._pt && (Ae = s,
                B.killTweensOf(C, U, s.globalTime(0)),
                fe = !s.parent,
                Ae = 0),
                s._pt && n && (ii[F.id] = 1)
            }
            E && yi(s),
            s._onInit && s._onInit(s)
        }
    ...
    , sa = (s,e)=>{
        let t = s[0] ? Ee(s[0]).harness : 0, i = t && t.aliases, r, a, n, o;
        if (!i)
            return e;
        r = Qe({}, e);
        for (a in i)
    ...
    , gt = (s,e,t,i,r)=>W(s) ? s.call(e, t, i, r) : j(s) && ~s.indexOf("random(") ? ct(s) : s, Os = ri + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase", ra = (Os + ",id,stagger,delay,duration,paused,scrollTrigger").split(","), L = class extends it {
        constructor(e, t, i, r) {
            typeof t == "number" && (i.duration = t,
            t = i,
            i = null),
            super(r ? t : Ct(t), i);
            let {duration: a, delay: n, immediateRender: o, stagger: l, overwrite: h, keyframes: d, defaults: c, scrollTrigger: p, yoyoEase: f} = this.vars, u = this.parent, g = (ne(e) || Zi(e) ? ue(e[0]) : "length"in t) ? [e] : xe(e), _, v, x, T, m, y, w, b;
            if (this._targets = g.length ? ai(g) : ts("GSAP target " + e + " not found. https://greensock.com", !q.nullTargetWarn) || [],
            this._ptLookup = [],
            this._overwrite = h,
            d || l || Qi(a) || Qi(n)) {
                if (t = this.vars,
                _ = this.timeline = new G({
                    data: "nested",
                    defaults: c || {}
                }),
                _.kill(),
                ...
                d)
                    ...
                    for (v = 0; v < T; v++) {
                        ...
                        !l && T === 1 && x.delay && (this._delay = n = x.delay,
                        this._start += n,
                        x.delay = 0),
                        _.to(y, x, w(v, y, g))
                    }
            ...
            Ae = 0),
            u && Dt(u, this),
            (o || !a && !d && this._start === S(u._time) && Z(o) && hs(this) && u.data !== "nested") && (this._tTime = -D,
            this.render(Math.max(0, -n))),
            p && us(this, p)
        }
        render(e, t, i) {
            let r = this._time, a = this._tDur, n = this._dur, o = e > a - D && e >= 0 ? a : e < D ? 0 : e, l, h, d, c, p, f, u, g, _;
            if (!n)
                Vr(this, e, t, i);
            else if (o !== this._tTime || !e || i || !this._initted && this._tTime || this._startAt && this._zTime < 0 != e < 0) {
                if (l = o,
                g = this.timeline,
                this._repeat) {
                    if (c = n + this._rDelay,
                    ...
                    l === r && !i && this._initted)
                        return this;
                    d !== p && (g && this._yEase && kt(g, f),
                    this.vars.repeatRefresh && !f && !this._lock && (this._lock = i = 1,
                    this.render(S(c * d), !0).invalidate()._lock = 0))
                }
                if (!this._initted) {
                    if (fs(this, e < 0 ? e : l, i, t))
                ...
                h = this._pt; h; )
                    h.r(u, h.d),
                    h = h._next;
                g && g.render(e < 0 ? e : !l && f ? -D : g._dur * u, t, i) || this._startAt && (this._zTime = e),
                this._onUpdate && !t && (e < 0 && this._startAt && this._startAt.render(e, !0, i),
                se(this, "onUpdate")),
                this._repeat && d !== p && this.vars.onRepeat && !t && this.parent && se(this, "onRepeat"),
                (o === this._tDur || !o) && this._tTime === o && (e < 0 && this._startAt && !this._onUpdate && this._startAt.render(e, !0, !0),
                (e || !n) && (o === this._tDur && this._ts > 0 || !o && this._ts < 0) && De(this, 1),
                !t && !(e < 0 && !r) && (o || r) && (se(this, o === a ? "onComplete" : "onReverseComplete", !0),
                this._prom && !(o < a && this.timeScale() > 0) && this._prom()))
            }
            return this
        ...
        kill(e, t="all") {
            ...
            if (this.timeline) {
                ...
                return this.timeline.killTweensOf(e, t, Ae && Ae.vars.overwrite !== !0)._first || ft(this),
                this.parent && u !== this.timeline.totalDuration() && Ke(this, this._dur * this.timeline._tDur / u, 0, 1),
                this
            }
            let i = this._targets, r = e ? xe(e) : i, a = this._ptLookup, n = this._pt, o, l, h, d, c, p, f;
            if ((!t || t === "all") && kr(i, r))
            ...
            f = i.length; f--; )
                if (~r.indexOf(i[f])) {
                    ...
                    for (c in d)
                        p = l && l[c],
                        p && ((!("kill"in p.d) || p.d.kill(c) === !0) && Mt(this, p, "_pt"),
                        delete l[c]),
                        h !== "all" && (h[c] = 1)
                }
            return this._initted && !this._pt && n && ft(this),
            this
        }
        static to(e, t) {
    ...
    ;
    J(ri + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger", s=>ti[s] = 1);
    ...
    var Vt = {
        ...
        getProperty(s, e, t, i) {
            ...
            let r = Ee(s || {}).get
              , a = t ? os : ns;
            return t === "native" && (t = ""),
            s && (e ? a((K[e] && K[e].get || r)(s, e, t, i)) : (n,o,l)=>a((K[n] && K[n].get || r)(s, n, o, l)))
        },
        quickSetter(s, e, t) {
            if (s = xe(s),
            s.length > 1) {
        ...
        defaults(s) {
            return s && s.ease && (s.ease = $e(s.ease, qe.ease)),
            oi(qe, s || {})
        },
        config(s) {
            return oi(q, s || {})
        ...
        registerEffect({name: s, effect: e, plugins: t, defaults: i, extendTimeline: r}) {
            (t || "").split(",").forEach(a=>a && !K[a] && !te[a] && ts(s + " effect requires " + a + " plugin.")),
            si[s] = (a,n,o)=>e(xe(a), he(n || {}, i), o),
            r && (G.prototype[s] = function(a, n, o) {
        ...
        exportRoot(s={}, e) {
            let t = new G(s), i, r;
            for (t.smoothChildTiming = Z(s.smoothChildTiming),
            B.remove(t),
            t._dp = 0,
            t._time = t._tTime = B._time,
            i = B._first; i; )
                r = i._next,
                (e || !(!i._dur && i instanceof L && i.vars.onComplete === i._targets[0])) && Pe(t, i, i._start - i._delay),
                i = r;
            return Pe(B, t, 0),
            t
        },
    ...
    var oa = (s,e)=>{
      ...
      , ha = (s,e)=>{
        let t = s._targets, i, r, a;
        for (i in e)
            for (r = t.length; r--; )
                a = s._ptLookup[r][i],
                a && (a = a.d) && (a._pt && (a = oa(a, i)),
                a && a.modifier && a.modifier(e[i], s, t[r], i))
    }
      , vi = (s,e)=>({
        name: s,
        rawVars: 1,
      ...
      , oe = Vt.registerPlugin({
        ...
        init(s, e) {
            let t = e.length;
            for (; t--; )
                this.add(s, t, s[t] || 0, e[t])
        }
    }, vi("roundProps", ui), vi("modifiers"), vi("snap", vs)) || Vt;
    L.version = G.version = oe.version = "3.6.0";
    $i = 1;
    qi() && Je();
    var Fs, ye, st, bi, je, _t, Vs, la = ()=>typeof window != "undefined", ke = {}, Ge = 180 / Math.PI, rt = Math.PI / 180, at = Math.atan2, zs = 1e8, Is = /([A-Z])/g, da = /(?:left|right|width|margin|padding|x)/i, ua = /[\s,\(]\S/, Oe = {
        autoAlpha: "opacity,visibility",
        scale: "scaleX,scaleY",
        alpha: "opacity"
    }, Us = (s,e)=>e.set(e.t, e.p, Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u, e), ca = (s,e)=>e.set(e.t, e.p, s === 1 ? e.e : Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u, e), fa = (s,e)=>e.set(e.t, e.p, s ? Math.round((e.s + e.c * s) * 1e4) / 1e4 + e.u : e.b, e), pa = (s,e)=>{
        let t = e.s + e.c * s;
        e.set(e.t, e.p, ~~(t + (t < 0 ? -.5 : .5)) + e.u, e)
    }
    , Bs = (s,e)=>e.set(e.t, e.p, s ? e.e : e.b, e), Ns = (s,e)=>e.set(e.t, e.p, s !== 1 ? e.b : e.e, e), ga = (s,e,t)=>s.style[e] = t, _a = (s,e,t)=>s.style.setProperty(e, t), ma = (s,e,t)=>s._gsap[e] = t, xa = (s,e,t)=>s._gsap.scaleX = s._gsap.scaleY = t, ya = (s,e,t,i,r)=>{
        let a = s._gsap;
        a.scaleX = a.scaleY = t,
    ...
    , re = "transform", Fe = re + "Origin", Ws, wi = (s,e)=>{
        let t = ye.createElementNS ? ye.createElementNS((e || "http://www.w3.org/1999/xhtml").replace(/^https/, "http"), s) : ye.createElement(s);
        return t.style ? t : ye.createElement(s)
    }
    , ve = (s,e,t)=>{
        let i = getComputedStyle(s);
        return i[e] || i.getPropertyValue(e.replace(Is, "-$1").toLowerCase()) || i.getPropertyValue(e) || !t && ve(s, nt(e) || e, 1) || ""
    }
    , js = "O,Moz,ms,Ms,Webkit".split(","), nt = (s,e,t)=>{
        let i = e || je
          , r = i.style
          , a = 5;
        if (s in r && !t)
    ...
    , zt = function(s) {
        let e = wi("svg", this.ownerSVGElement && this.ownerSVGElement.getAttribute("xmlns") || "http://www.w3.org/2000/svg"), t = this.parentNode, i = this.nextSibling, r = this.style.cssText, a;
        if (st.appendChild(e),
        e.appendChild(this),
        ...
        let t = e.length;
        for (; t--; )
            if (s.hasAttribute(e[t]))
                return s.getAttribute(e[t])
    }
    , Hs = s=>{
        let e;
        try {
        ...
        return e && (e.width || e.height) || s.getBBox === zt || (e = zt.call(s, !0)),
        e && !e.width && !e.x && !e.y ? {
            x: +Gs(s, ["x", "cx", "x1"]) || 0,
            y: +Gs(s, ["y", "cy", "y1"]) || 0,
            width: 0,
    ...
    , Xs = s=>!!(s.getCTM && (!s.parentNode || s.ownerSVGElement) && Hs(s)), It = (s,e)=>{
        if (e) {
            let t = s.style;
            e in ke && e !== Fe && (e = re),
            t.removeProperty ? ((e.substr(0, 2) === "ms" || e.substr(0, 6) === "webkit") && (e = "-" + e),
            t.removeProperty(e.replace(Is, "-$1").toLowerCase())) : t.removeAttribute(e)
        }
    }
    , Ve = (s,e,t,i,r,a)=>{
    ...
    , Ys = {
        ...
        let r = parseFloat(t) || 0, a = (t + "").trim().substr((r + "").length) || "px", n = je.style, o = da.test(e), l = s.tagName.toLowerCase() === "svg", h = (l ? "client" : "offset") + (o ? "Width" : "Height"), d = 100, c = i === "px", p = i === "%", f, u, g, _;
        return i === a || !r || Ys[i] || Ys[a] ? r : (a !== "px" && !c && (r = Re(s, e, t, "px")),
        _ = s.getCTM && Xs(s),
        (p || a === "%") && (ke[e] || ~e.indexOf("adius")) ? (f = _ ? s.getBBox()[o ? "width" : "height"] : s[h],
        S(p ? r / f * d : r / 100 * f)) : (n[o ? "width" : "height"] = d + (c ? a : i),
        u = ~e.indexOf("adius") || i === "em" && s.appendChild && !l ? s : s.parentNode,
        _ && (u = (s.ownerSVGElement || {}).parentNode),
        (!u || u === ye || !u.appendChild) && (u = ye.body),
        g = u._gsap,
        g && p && g.width && o && g.time === ie.time ? S(r / g.width * d) : ((p || a === "%") && (n.position = ve(s, "position")),
    ...
    , ot = (s,e,t,i)=>{
        let r;
        return bi || Ti(),
        e in Oe && e !== "transform" && (e = Oe[e],
        ~e.indexOf(",") && (e = e.split(",")[0])),
        ke[e] && e !== "transform" ? (r = Bt(s, i),
        r = e !== "transformOrigin" ? r[e] : Nt(ve(s, Fe)) + " " + r.zOrigin + "px") : (r = s.style[e],
        (!r || r === "auto" || i || ~(r + "").indexOf("calc(")) && (r = Ut[e] && Ut[e](s, e, t) || ve(s, e) || ni(s, e) || (e === "opacity" ? 1 : 0))),
    ...
    , ba = function(s, e, t, i) {
        if (!t || t === "none") {
            let m = nt(e, s, 1)
              , y = m && ve(s, m, 1);
            y && y !== t ? (e = m,
            t = y) : e === "borderColor" && (t = ve(s, "borderTopColor"))
        }
        let r = new X(this._pt,s.style,e,0,1,_i), a = 0, n = 0, o, l, h, d, c, p, f, u, g, _, v, x, T;
        if (r.b = t,
        r.e = i,
        t += "",
        i += "",
        ...
        T.length) {
            for (; l = Be.exec(i); )
                ...
                c ? c = (c + 1) % 5 : (g.substr(-5) === "rgba(" || g.substr(-5) === "hsla(") && (c = 1),
                f !== (p = h[n++] || "") && (d = parseFloat(p) || 0,
                v = p.substr((d + "").length),
            ...
            r.r = e === "display" && i === "none" ? Ns : Bs;
        return $t.test(i) && (r.e = 0),
        this._pt = r,
        r
    }, qs = {
        top: "0%",
        ...
        let e = s.split(" ")
          , t = e[0]
          , i = e[1] || "50%";
        return (t === "top" || t === "bottom" || i === "left" || i === "right") && (s = t,
        t = i,
        i = s),
        e[0] = qs[t] || t,
        e[1] = qs[i] || i,
    ...
    , Ta = (s,e)=>{
        if (e.tween && e.tween._time === e.tween._dur) {
            let t = e.t, i = t.style, r = e.u, a = t._gsap, n, o, l;
            if (r === "all" || r === !0)
                i.cssText = "",
                o = 1;
            else
                ...
                l = r.length; --l > -1; )
                    n = r[l],
                    ke[n] && (o = 1,
                    n = n === "transformOrigin" ? Fe : re),
                    It(t, n);
            o && (It(t, re),
            a && (a.svg && t.removeAttribute("transform"),
            Bt(t, 1),
            a.uncache = 1))
        }
    }
    ...
    }, mt = [1, 0, 0, 1, 0, 0], Qs = {}, Zs = s=>s === "matrix(1, 0, 0, 1, 0, 0)" || s === "none" || !s, Ks = s=>{
        let e = ve(s, re);
        return Zs(e) ? mt : e.substr(7).match(Kt).map(S)
    }
    , Pi = (s,e)=>{
        let t = s._gsap || Ee(s), i = s.style, r = Ks(s), a, n, o, l;
        return t.svg && s.getAttribute("transform") ? (o = s.transform.baseVal.consolidate().matrix,
        r = [o.a, o.b, o.c, o.d, o.e, o.f],
        r.join(",") === "1,0,0,1,0,0" ? mt : r) : (r === mt && !s.offsetParent && s !== st && !t.svg && (o = i.display,
        i.display = "block",
        a = s.parentNode,
        (!a || !s.offsetParent) && (l = 1,
        n = s.nextSibling,
        st.appendChild(s)),
        r = Ks(s),
    ...
    , Ri = (s,e,t,i,r,a)=>{
        let n = s._gsap, o = r || Pi(s, !0), l = n.xOrigin || 0, h = n.yOrigin || 0, d = n.xOffset || 0, c = n.yOffset || 0, p = o[0], f = o[1], u = o[2], g = o[3], _ = o[4], v = o[5], x = e.split(" "), T = parseFloat(x[0]) || 0, m = parseFloat(x[1]) || 0, y, w, b, P;
        t ? o !== mt && (w = p * g - f * u) && (b = T * (g / w) + m * (-u / w) + (u * v - g * _) / w,
        P = T * (-f / w) + m * (p / w) - (p * v - f * _) / w,
        T = b,
        m = P) : (y = Hs(s),
        T = y.x + (~x[0].indexOf("%") ? T / 100 * y.width : T),
        m = y.y + (~(x[1] || x[0]).indexOf("%") ? m / 100 * y.height : m)),
        i || i !== !1 && n.smooth ? (_ = T - l,
        v = m - h,
        n.xOffset = d + (_ * p + v * u) - _,
        n.yOffset = c + (_ * f + v * g) - v) : n.xOffset = n.yOffset = 0,
        n.xOrigin = T,
        n.yOrigin = m,
        n.smooth = !!i,
        n.origin = e,
    ...
    , Bt = (s,e)=>{
        ...
        if ("x"in t && !e && !t.uncache)
            return t;
        let i = s.style, r = t.scaleX < 0, a = "px", n = "deg", o = ve(s, Fe) || "0", l, h, d, c, p, f, u, g, _, v, x, T, m, y, w, b, P, C, E, F, I, k, U, V, M, fe, pe, Ce, ge, Xi, we, Ue;
        return l = h = d = f = u = g = _ = v = x = 0,
        c = p = 1,
        t.svg = !!(s.getCTM && Xs(s)),
        y = Pi(s, t.svg),
        t.svg && (V = !t.uncache && s.getAttribute("data-svg-origin"),
        ...
        l = k = y[4],
        h = U = y[5],
        y.length === 6 ? (c = Math.sqrt(C * C + E * E),
        p = Math.sqrt(I * I + F * F),
        f = C || E ? at(E, C) * Ge : 0,
        _ = F || I ? at(F, I) * Ge + f : 0,
        _ && (p *= Math.cos(_ * rt)),
        ...
        C = V,
        k = M),
        u && Math.abs(u) + Math.abs(f) > 359.9 && (u = f = 0,
        g = 180 - g),
        ...
        x = we ? 1 / (we < 0 ? -we : we) : 0),
        t.svg && (V = s.getAttribute("transform"),
        t.forceCSS = s.setAttribute("transform", "") || !Zs(ve(s, re)),
        V && s.setAttribute("transform", V))),
        Math.abs(_) > 90 && Math.abs(_) < 270 && (r ? (c *= -1,
        _ += f <= 0 ? 180 : -180,
        f += f <= 0 ? 180 : -180) : (p *= -1,
        _ += _ <= 0 ? 180 : -180)),
        t.x = l - ((t.xPercent = l && (t.xPercent || (Math.round(s.offsetWidth / 2) === Math.round(-l) ? -50 : 0))) ? s.offsetWidth * t.xPercent / 100 : 0) + a,
        t.y = h - ((t.yPercent = h && (t.yPercent || (Math.round(s.offsetHeight / 2) === Math.round(-h) ? -50 : 0))) ? s.offsetHeight * t.yPercent / 100 : 0) + a,
        t.z = d + a,
        t.scaleX = S(c),
        t.scaleY = S(p),
        t.rotation = S(f) + n,
    ...
    , He = "0deg", xt = "0px", Xe = ") ", Js = function(s, e) {
        let {xPercent: t, yPercent: i, x: r, y: a, z: n, rotation: o, rotationY: l, rotationX: h, skewX: d, skewY: c, scaleX: p, scaleY: f, transformPerspective: u, force3D: g, target: _, zOrigin: v} = e || this
          , x = ""
          , T = g === "auto" && s && s !== 1 || g === !0;
        if (v && (h !== He || l !== He)) {
            let m = parseFloat(l) * rt, y = Math.sin(m), w = Math.cos(m), b;
            m = parseFloat(h) * rt,
            b = Math.cos(m),
            r = Si(_, r, y * b * -v),
        ...
        (t || i) && (x += "translate(" + t + "%, " + i + "%) "),
        (T || r !== xt || a !== xt || n !== xt) && (x += n !== xt || T ? "translate3d(" + r + ", " + a + ", " + n + ") " : "translate(" + r + ", " + a + Xe),
        o !== He && (x += "rotate(" + o + Xe),
        l !== He && (x += "rotateY(" + l + Xe),
        h !== He && (x += "rotateX(" + h + Xe),
        ...
        let {xPercent: t, yPercent: i, x: r, y: a, rotation: n, skewX: o, skewY: l, scaleX: h, scaleY: d, target: c, xOrigin: p, yOrigin: f, xOffset: u, yOffset: g, forceCSS: _} = e || this, v = parseFloat(r), x = parseFloat(a), T, m, y, w, b;
        n = parseFloat(n),
        o = parseFloat(o),
        l = parseFloat(l),
        l && (l = parseFloat(l),
        ...
        w = d,
        m = y = 0),
        (v && !~(r + "").indexOf("px") || x && !~(a + "").indexOf("px")) && (v = Re(c, "x", r, "px"),
        x = Re(c, "y", a, "px")),
        (p || f || u || g) && (v = S(v + p - (p * T + f * y) + u),
        x = S(x + f - (p * m + f * w) + g)),
        (t || i) && (b = c.getBBox(),
        v = S(v + t / 100 * b.width),
        x = S(x + i / 100 * b.height)),
        b = "matrix(" + T + "," + m + "," + y + "," + w + "," + v + "," + x + ")",
        c.setAttribute("transform", b),
        _ && (c.style[re] = b)
    }, Sa = function(s, e, t, i, r, a) {
        let n = 360, o = j(r), l = parseFloat(r) * (o && ~r.indexOf("rad") ? Ge : 1), h = a ? l * a : l - i, d = i + h + "deg", c, p;
        return o && (c = r.split("_")[1],
        c === "short" && (h %= n,
        h !== h % (n / 2) && (h += h < 0 ? n : -n)),
        c === "cw" && h < 0 ? h = (h + n * zs) % n - ~~(h / n) * n : c === "ccw" && h > 0 && (h = (h - n * zs) % n - ~~(h / n) * n)),
        ...
        let i = _t.style, r = t._gsap, a = "perspective,force3D,transformOrigin,svgOrigin", n, o, l, h, d, c, p, f;
    ...
    J("padding,margin,Width,Radius", (s,e)=>{
        let t = "Top"
          ...
          , r = "Bottom"
          , a = "Left"
          , n = (e < 3 ? [t, i, r, a] : [t + a, t + i, r + i, r + a]).map(o=>e < 2 ? s + o : "border" + o + s);
        Ut[e > 1 ? "border" + s : s] = function(o, l, h, d, c) {
            let p, f;
            if (arguments.length < 4)
                return p = n.map(u=>ot(o, u, h)),
                f = p.join(" "),
    ...
    var Ci = {
        ...
        init(s, e, t, i, r) {
            let a = this._props, n = s.style, o = t.vars.startAt, l, h, d, c, p, f, u, g, _, v, x, T, m, y, w;
            bi || Ti();
            for (u in e)
                if (u !== "autoRound" && (h = e[u],
                !(K[u] && xi(u, e, t, i, s, r)))) {
                    if (p = typeof h,
                    f = Ut[u],
                    p === "function" && (h = h.call(t, i, s, r),
                    p = typeof h),
                    ...
                    f)
                        ...
                        if (o && u in o ? (l = typeof o[u] == "function" ? o[u].call(t, i, s, r) : o[u],
                        u in q.units && !$(l) && (l += q.units[u]),
                        (l + "").charAt(1) === "=" && (l = ot(s, u))) : l = ot(s, u),
                        c = parseFloat(l),
                        v = p === "string" && h.charAt(1) === "=" ? +(h.charAt(0) + "1") : 0,
                        v && (h = h.substr(2)),
                        d = parseFloat(h),
                        u in Oe && (u === "autoAlpha" && (c === 1 && ot(s, "visibility") === "hidden" && d && (c = 0),
                        Ve(this, n, "visibility", c ? "inherit" : "hidden", d ? "inherit" : "hidden", !d)),
                        u !== "scale" && u !== "transform" && (u = Oe[u],
                        ...
                        x) {
                            ...
                            u === "scale")
                                ...
                                h = wa(h),
                                m.svg ? Ri(s, h, 0, y, 0, this) : (_ = parseFloat(h.split(" ")[2]) || 0,
                        ...
                        if (x || (d || d === 0) && (c || c === 0) && !ua.test(h) && u in n)
                            ...
                            g !== _ && (c = Re(s, u, l, _)),
                            this._pt = new X(this._pt,x ? m : n,u,c,v ? v * d : d - c,!x && (_ === "px" || u === "zIndex") && e.autoRound !== !1 ? pa : Us),
                            this._pt.u = _ || 0,
                            g !== _ && (this._pt.b = l,
                            this._pt.r = fa);
                        else if (u in n)
                            ba.call(this, s, u, l, h);
                        else if (u in s)
                            this.add(s, u, s[u], h, i, r);
                        else {
                            Tt(u, h);
                            continue
                        }
        ...
        getSetter(s, e, t) {
            ...
            e in ke && e !== Fe && (s._gsap.x || ot(s, "x")) ? t && Vs === t ? e === "scale" ? xa : ma : (Vs = t || {}) && (e === "scale" ? ya : va) : s.style && !bt(s.style[e]) ? ga : ~e.indexOf("-") ? _a : Lt(s, e)
        },
        core: {
            _removeProperty: It,
            _getMatrix: Pi
    ...
    var $s = 0
      , Mi = class {
        constructor({root: e, rootMargin: t="0px", threshold: i=0}) {
            window.IntersectionObserver ? (this.root = document.querySelector(e),
            ...
            e.forEach(t=>{
                ...
                if (i) {
                    if (t.intersectionRatio > i.triggerRatio) {
                        ...
                        i.inView && t.intersectionRatio <= i.triggerRatio && (i.inView = !1,
                        i.onElHidden && i.onElHidden(i),
                        i.keepObserving || this._unobserve(i));
                    i.ratio = t.intersectionRatio,
                    i.boundingClientRect = t.boundingClientRect
                }
            }
            )
        }
        observe({elements: e=[], selector: t, keepObserving: i=!1, triggerRatio: r=0, alwaysTrigger: a=!0, stagger: n=0, onBeforeElVisible: o=()=>{}
        , onElVisible: l=()=>{}
        , onElHidden: h=()=>{}
        }) {
        ...
        _unobserve(e) {
            ...
            this.els = this.els.filter(t=>!t.el.isSameNode(e.el))
        }
        unobserveEl(e) {
    ...
    "use strict";
    var Ei = class {
        constructor({container: e=document.body, cancelNavigationClass: t, cacheLinks: i, cacheNavigatedPages: r=!1, cacheLength: a=10, isiOS: n=!1, onStart: o={
            value: ()=>{}
        }, onReady: l={
            value: ()=>{}
        }, onLeaving: h={
            ...
            this._initEvents(),
            this.params.cacheNavigatedPages && this._cacheResponse(window.location.href, document.documentElement.innerHTML),
            this.params.cacheLinks && this._cacheContainerLinks()
        }
        _initEvents() {
            if (window.addEventListener("hashchange", ()=>{
            ...
            window.addEventListener("popstate", ()=>{
                ...
                if (t.indexOf("#") !== -1) {
                    ...
                    r = t;
                i === r && (a = !0),
                a || this._launchNavigation(window.location.href, !1)
            }
            ),
            ...
            window.MutationObserver && (this._mutations.isActive = !0,
        ...
        _handleClick(e) {
            let t = e.target;
            if (t.name !== "A" && (t = t.closest("a")),
            !t)
                return;
            let i = t.getAttribute("href");
            if (!(this.params.cancelNavigationClass && t.classList.contains(this.params.cancelNavigationClass)) && i.indexOf("mailto:") === -1 && !t.getAttribute("download") && !(e.ctrlKey || e.metaKey || e.shiftKey || e.altKey)) {
        ...
        _cacheResponse(e, t) {
            ...
            this.cache.length >= this.params.cacheLength && this.cache.splice(0, 1),
            this.cache.push(i)
        }
        _cacheContainerLinks() {
            ...
            for (let t = 0; t < e.length; t++) {
                let i = e[t].href;
                this.cache.find(a=>a.href === i) || this._AJAXCall(i, !1, (a,n)=>this._cacheResponse(n, a))
            }
        }
        loadPage(e, t) {
        ...
        _launchNavigation(e, t) {
            if (!this._isLoading) {
                ...
                let i = this._transitionsManager.isOverriding ? this._transitionsManager.overrideDuration : this.params.onLeaving.duration
                  , r = this.cache.find(a=>a.href === e);
                r ? (this.router.nextHref = r.href,
                this.router.nextHTMLContent = r.HTMLContent,
                this.router.nextTitle = r.title) : this._routing(e, t),
                setTimeout(()=>{
                    this.params.onLeaving.value(this.router.history[this.router.history.length - 1].href, e),
        ...
        _routing(e, t) {
            ...
            e ? this.router.nextHref = e : this.router.history.length > 0 && (this.router.nextHref = this.router.history[this.router.history.length - 1].href),
            this.router.nextHref && this._AJAXCall(e, t, (i,r)=>{
                this.router.nextHTMLContent = this._parseResponseContent(i),
                this.router.nextTitle = i.match(/<title[^>]*>([^<]+)<\/title>/)[1],
                this.params.cacheNavigatedPages && (this.cache.find(n=>n.href === e) || this._cacheResponse(r, i))
            }
            )
        }
        _AJAXCall(e, t, i) {
            ...
            r.onreadystatechange = ()=>{
                r.readyState === 4 && (r.status === 200 || r.status === 0) ? i && i(r.response, r.responseURL) : r.readyState === 4 && r.status !== 404 && this._ajaxCalls < 4 ? (this._ajaxCalls === 0 && !this._transitionsManager.isWaiting && (this._transitionsManager.isWaiting = !0,
                this.params.onWaiting.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref)),
                this._ajaxCalls++,
                this._routing(r.responseURL, t, i)) : r.readyState === 4 && (this._resetRoutingState(),
                this.params.onError.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref))
            }
            ,
            r.open("GET", e, !0),
        ...
        _waitForData(e) {
            this._transitionsManager.isWaiting || (this._transitionsManager.isWaiting = !0,
            this.params.onWaiting.value(this.router.history[this.router.history.length - 1].href, this.router.nextHref));
            let t = setInterval(()=>{
                this.router.nextHTMLContent && (clearInterval(t),
                this._appendData(e))
            }
            , 1e3)
        }
        ...
        _newContentAdded() {
            setTimeout(()=>{
                this.params.onReady.value(this.router.history[this.router.history.length - 2].href, this.router.history[this.router.history.length - 1].href),
        ...
        _appendData(e) {
            ...
            t && (this._mutations.isActive ? this._mutations.mutationObserver.observe(this.container, {
                childList: !0
            }) : setTimeout(()=>{
                this._newContentAdded()
            }
        ...
        overrideTransitionDuration(e=50) {
            this._transitionsManager.isOverriding = !0,
            this._transitionsManager.overrideDuration = e
        }
    ...
    var Li = class {
        constructor(e) {
            this.type = "Scene",
            !e || e.type !== "Renderer" ? z(this.type + ": Renderer not passed as first argument", e) : e.gl || z(this.type + ": Renderer WebGL context is undefined", e),
            this.renderer = e,
            this.gl = e.gl,
            this.initStacks()
        }
        ...
        addToRenderTargetsStack(e) {
            let t = this.renderer.planes.filter(r=>r.type !== "PingPongPlane" && r.target && r.uuid !== e.uuid)
              , i = -1;
            if (e.target._depth) {
                ...
                i = t.findIndex(r=>r.target.uuid === e.target.uuid);
            i = Math.max(0, i),
            t.splice(i, 0, e),
            e.target._depth ? (t.sort((r,a)=>r.index - a.index),
            t.sort((r,a)=>a.renderOrder - r.renderOrder)) : (t.sort((r,a)=>a.index - r.index),
        ...
        addToRegularPlaneStack(e) {
            let t = this.renderer.planes.filter(r=>r.type !== "PingPongPlane" && !r.target && r._transparent === e._transparent && r.uuid !== e.uuid)
              , i = -1;
            for (let r = t.length - 1; r >= 0; r--)
        ...
        setPlaneRenderOrder(e) {
            ...
            if (e.target)
                ...
                !this.renderer.depth || i ? (t.sort((r,a)=>a.index - r.index),
                e._transparent && t.sort((r,a)=>r.relativeTranslation.z - a.relativeTranslation.z),
                t.sort((r,a)=>r.renderOrder - a.renderOrder)) : (t.sort((r,a)=>r.index - a.index),
    ...
    ;
    var Oi = class {
        constructor({alpha: e, antialias: t, premultipliedAlpha: i, depth: r, failIfMajorPerformanceCaveat: a, preserveDrawingBuffer: n, stencil: o, container: l, pixelRatio: h, renderingScale: d, production: c, onError: p, onSuccess: f, onContextLost: u, onContextRestored: g, onDisposed: _, onSceneChange: v}) {
            this.type = "Renderer",
            this.alpha = e,
            this.antialias = t,
        ...
        getExtensions() {
            ...
            this.extensions.KHR_parallel_shader_compile = this.gl.getExtension("KHR_parallel_shader_compile")) : (this.extensions.OES_vertex_array_object = this.gl.getExtension("OES_vertex_array_object"),
            ...
            this.extensions.WEBGL_lose_context = this.gl.getExtension("WEBGL_lose_context"),
            this.extensions.KHR_parallel_shader_compile = this.gl.getExtension("KHR_parallel_shader_compile"))
        }
        contextLost(e) {
        ...
        restoreContext() {
            ...
            this.gl && this.extensions.WEBGL_lose_context ? this.extensions.WEBGL_lose_context.restoreContext() : (!this.gl && !this.production ? R(this.type + ": Could not restore the context because the context is not defined") : !this.extensions.WEBGL_lose_context && !this.production && R(this.type + ": Could not restore the context because the restore context extension is not defined"),
            this.onError && this.onError()))
        }
    ...
    ;
    var Fi = class {
        constructor({xOffset: e=0, yOffset: t=0, lastXDelta: i=0, lastYDelta: r=0, shouldWatch: a=!0, onScroll: n=()=>{}
        }={}) {
            this.xOffset = e,
            this.yOffset = t,
            this.lastXDelta = i,
    ...
    ;
    var Wt = class {
        constructor({container: e, alpha: t=!0, premultipliedAlpha: i=!1, antialias: r=!0, depth: a=!0, failIfMajorPerformanceCaveat: n=!0, preserveDrawingBuffer: o=!1, stencil: l=!1, autoResize: h=!0, autoRender: d=!0, watchScroll: c=!0, pixelRatio: p=window.devicePixelRatio || 1, renderingScale: f=1, production: u=!1}={}) {
            this.type = "Curtains",
            this._autoResize = h,
            this._autoRender = d,
            this._watchScroll = c,
            ...
            this._renderingScale = Math.max(.25, Math.min(1, f)),
            this.premultipliedAlpha = i,
            this.alpha = t,
            this.antialias = r,
            this.depth = a,
            ...
            this.production = u,
            this.errors = !1,
            e ? this.setContainer(e) : this.production || R(this.type + ": no container provided in the initial parameters. Use setContainer() method to set one later and initialize the WebGL context")
        }
        setContainer(e) {
            if (e)
                if (typeof e == "string")
                    ...
                    e)
                        ...
                        this.container = t,
                        this.production || R('Curtains: no valid container HTML element or ID provided, created a div with "curtains-canvas" ID instead')
                    }
                else
        ...
        setUniforms() {
            if (this.uniforms)
                for (let e in this.uniforms) {
                    ...
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 4f (array of 4 floats) uniform type")) : t.value.length === 3 ? (t.type = "3f",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 3f (array of 3 floats) uniform type")) : t.value.length === 2 && (t.type = "2f",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 2f (array of 2 floats) uniform type")) : t._internalFormat === "mat" ? t.value.length === 16 ? (t.type = "mat4",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat4 (4x4 matrix array) uniform type")) : t.value.length === 9 ? (t.type = "mat3",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat3 (3x3 matrix array) uniform type")) : t.value.length === 4 && (t.type = "mat2",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a mat2 (2x2 matrix array) uniform type")) : (t.type = "1f",
                    this.renderer.production || R(this.type + ": No uniform type declared for " + t.name + ", applied a 1f (float) uniform type"))),
    ...
    var ar = 0
      , Gt = class {
        constructor(e, {parent: t, vertexShader: i, fragmentShader: r}={}) {
            ...
            i ? this.vsCode = i : (!this.renderer.production && this.parent.type === "Plane" && R(this.parent.type + ": No vertex shader provided, will use a default one"),
            this.vsCode = this.defaultVsCode),
            r ? this.fsCode = r : (this.renderer.production || R(this.parent.type + ": No fragment shader provided, will use a default one"),
...
`);
                ...
                return n = n.join(`
`),
                R(this.type + ": Errors occurred while compiling the", r, `:
`, this.gl.getShaderInfoLog(i)),
        ...
        useNewShaders() {
            ...
            (!this.vertexShader || !this.fragmentShader) && (this.renderer.production || R(this.type + ": Unable to find or compile the vertex or fragment shader"))
        }
        setupProgram() {
        ...
        createProgram() {
            ...
            !this.activeUniforms) {
                ...
                for (let t = 0; t < e; t++) {
                    ...
                    i.type === this.gl.FLOAT_MAT4 && i.name !== "uMVMatrix" && i.name !== "uPMatrix" && this.activeUniforms.textureMatrices.push(i.name)
                }
            }
        }
        createUniforms(e) {
            this.uniformsManager = new Vi(this.renderer,this.program,e),
            this.setUniforms()
        }
        setUniforms() {
    ...
    var zi = class {
        ...
        initAttributes() {
            for (let e in this.attributes)
                this.attributes[e].location = this.gl.getAttribLocation(this.program, this.attributes[e].name),
        ...
        computeVerticesUVs() {
            ...
            for (let i = 0; i < this.definition.height; i++) {
                ...
                for (let a = 0; a < this.definition.width; a++) {
                    ...
                    t.push(r),
                    t.push(0),
                    e.push((n + 1 / this.definition.width - .5) * 2),
                    e.push((r - .5) * 2),
                    e.push(0),
                    t.push(n),
                    ...
                    t.push(0),
                    e.push((n - .5) * 2),
                    e.push((r + 1 / this.definition.height - .5) * 2),
                    e.push(0),
                    t.push(n),
                    t.push(r + 1 / this.definition.height),
                    t.push(0),
    ...
    var Q = class {
        ...
        multiply(e) {
            let t = this.elements
              , i = e.elements
              , r = new Q;
            return r.elements[0] = i[0] * t[0] + i[1] * t[4] + i[2] * t[8] + i[3] * t[12],
    ...
    var A = class {
        ...
        applyQuat(e) {
            let t = this._x
              ...
              , c = l * r + a * i - n * t
              , p = -a * t - n * i - o * r;
            return this._x = h * l + p * -a + d * -o - c * -n,
    ...
    var Ii = new N
      ...
      , Va = new Q
      , ae = class {
        constructor(e, {isFBOTexture: t=!1, fromTexture: i=!1, loader: r, sampler: a, floatingPoint: n="none", premultiplyAlpha: o=!1, anisotropy: l=1, generateMipmap: h=null, wrapS: d, wrapT: c, minFilter: p, magFilter: f}={}) {
        ...
        _setParent() {
            ...
            this._parent._program) {
                if (!this._parent._program.compiled) {
                    this.renderer.production || R(this.type + ": Unable to create the texture because the program is not valid");
                    return
                }
        ...
        _setTextureUniforms() {
            ...
            for (let t = 0; t < e.textures.length; t++)
                ...
                e.textureMatrices.find(r=>r === this._textureMatrix.name) && (this._textureMatrix.isActive = !0,
        ...
        setSource(e) {
            ...
            this.source = e,
            this.sourceType === "empty" && (e.tagName.toUpperCase() === "IMG" ? this.sourceType = "image" : e.tagName.toUpperCase() === "VIDEO" ? (this.sourceType = "video",
            this.shouldUpdate = !0) : e.tagName.toUpperCase() === "CANVAS" ? (this.sourceType = "canvas",
            this._willUpdate = !0,
            this.shouldUpdate = !0) : this.renderer.production || R(this.type + ": this HTML tag could not be converted into a texture:", e.tagName)),
            this._size = {
        ...
        _updateGlobalTexParameters() {
            ...
            this._globalParameters.type = this.gl.FLOAT) : this.renderer.extensions.OES_texture_float ? this._globalParameters.type = this.renderer.extensions.OES_texture_half_float.FLOAT : this.renderer.production || R(this.type + ": could not use float textures because the extension is not available"))
        }
        _updateTexParameters() {
            this.index && this.renderer.state.activeTexture !== this.index && this._bindTexture(this),
            this.parameters.wrapS !== this._state.wrapS && (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.wrapS = this.gl.CLAMP_TO_EDGE),
            this.parameters.wrapS !== this.gl.REPEAT && this.parameters.wrapS !== this.gl.CLAMP_TO_EDGE && this.parameters.wrapS !== this.gl.MIRRORED_REPEAT && (this.renderer.production || R(this.type + ": Wrong wrapS value", this.parameters.wrapS, "for this texture:", this, `
gl.CLAMP_TO_EDGE wrapping will be used instead`),
            ...
            this.parameters.wrapT !== this._state.wrapT && (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.wrapT = this.gl.CLAMP_TO_EDGE),
            this.parameters.wrapT !== this.gl.REPEAT && this.parameters.wrapT !== this.gl.CLAMP_TO_EDGE && this.parameters.wrapT !== this.gl.MIRRORED_REPEAT && (this.renderer.production || R(this.type + ": Wrong wrapT value", this.parameters.wrapT, "for this texture:", this, `
gl.CLAMP_TO_EDGE wrapping will be used instead`),
            ...
            this.parameters.generateMipmap && !this._state.generateMipmap && this.source && (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) ? this.parameters.generateMipmap = !1 : this.gl.generateMipmap(this.gl.TEXTURE_2D),
            this._state.generateMipmap = this.parameters.generateMipmap),
            this.parameters.minFilter !== this._state.minFilter && (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.minFilter = this.gl.LINEAR),
...
gl.LINEAR filtering will be used instead`),
            ...
            this.parameters.magFilter !== this._state.magFilter && (!this.renderer._isWebGL2 && (!ce(this._size.width) || !ce(this._size.height)) && (this.parameters.magFilter = this.gl.LINEAR),
            this.parameters.magFilter !== this.gl.LINEAR && this.parameters.magFilter !== this.gl.NEAREST && (this.renderer.production || R(this.type + ": Wrong magFilter value", this.parameters.magFilter, "for this texture:", this, `
gl.LINEAR filtering will be used instead`),
        ...
        _getSizes() {
            ...
            let e = this._parent.scale ? Ii.set(this._parent.scale.x, this._parent.scale.y) : Ii.set(1, 1)
              ...
              , l = 0
              , h = 0;
            return o > n ? h = Math.min(0, i - t * (1 / n)) : o < n && (l = Math.min(0, t - i * n)),
            {
                parentWidth: t,
                parentHeight: i,
                sourceWidth: r,
        ...
        setScale(e) {
            ...
            e.sanitizeNaNValuesWith(this.scale).max(Ii.set(.001, .001)),
        ...
        _updateTextureMatrix(e) {
            let t = Fa.set(e.parentWidth / (e.parentWidth - e.xOffset), e.parentHeight / (e.parentHeight - e.yOffset), 1);
            t.x /= this.scale.x,
            t.y /= this.scale.y,
            this._textureMatrix.matrix = Va.setFromArray([t.x, 0, 0, 0, 0, t.y, 0, 0, 0, 0, 1, 0, (1 - t.x) / 2 + this.offset.x, (1 - t.y) / 2 + this.offset.y, 0, 1]),
    ...
    var Ht = class {
        ...
        _getSourceType(e) {
            let t;
            return typeof e == "string" ? e.match(/\.(jpeg|jpg|jfif|pjpeg|pjp|gif|bmp|png|webp|svg)$/) !== null ? t = "image" : e.match(/\.(webm|mp4|ogg|mov)$/) !== null && (t = "video") : e.tagName.toUpperCase() === "IMG" ? t = "image" : e.tagName.toUpperCase() === "VIDEO" ? t = "video" : e.tagName.toUpperCase() === "CANVAS" && (t = "canvas"),
            t
        }
        _createImage(e) {
        ...
        loadImage(e, t={}, i, r) {
            ...
            n.loader = this,
            a) {
                n.sampler = typeof e != "string" && e.hasAttribute("data-sampler") ? e.getAttribute("data-sampler") : n.sampler,
                n.fromTexture = a;
                let d = new ae(this.renderer,n);
                this._sourceLoaded(a.source, d, i),
                this._parent && this._addToParent(d, a.source, "image");
                return
            }
    ...
    var Ui = class extends Ht {
        constructor(e, t, {sourcesLoaded: i=0, sourcesToLoad: r=0, complete: a=!1, onComplete: n=()=>{}
        }={}) {
            super(e, t.crossOrigin);
            this.type = "PlaneTextureLoader",
            this._parent = t,
            this._parent.type !== "Plane" && this._parent.type !== "PingPongPlane" && this._parent.type !== "ShaderPass" && (R(this.type + ": Wrong parent type assigned to this loader"),
            this._parent = null),
    ...
    ;
    var Bi = class {
        constructor(e, t="Mesh", {vertexShaderID: i, fragmentShaderID: r, vertexShader: a, fragmentShader: n, uniforms: o={}, widthSegments: l=1, heightSegments: h=1, renderOrder: d=0, depthTest: c=!0, cullFace: p="back", texturesOptions: f={}, crossOrigin: u="anonymous"}={}) {
            this.type = t,
            e = e && e.renderer || e,
            (!e || e.type !== "Renderer") && (z(this.type + ": Curtains not passed as first argument or Curtains Renderer is missing", e),
            setTimeout(()=>{
                this._onErrorCallback && this._onErrorCallback()
            }
            , 0)),
            this.renderer = e,
            this.gl = this.renderer.gl,
            this.gl || (this.renderer.production || z(this.type + ": Unable to create a " + this.type + " because the Renderer WebGl context is not defined"),
            setTimeout(()=>{
                this._onErrorCallback && this._onErrorCallback()
            }
            , 0)),
            ...
            l = parseInt(l),
            h = parseInt(h),
            this._geometry = new zi(this.renderer,{
                width: l,
                height: h
            }),
        ...
        setRenderTarget(e) {
            if (!e || e.type !== "RenderTarget") {
                this.renderer.production || R(this.type + ": Could not set the render target because the argument passed is not a RenderTarget class object", e);
                return
            }
        ...
        loadSource(e, t={}, i, r) {
            this.loader.loadSource(e, Object.assign(t, this._texturesOptions), a=>{
                i && i(a)
            }
            , (a,n)=>{
                this.renderer.production || R(this.type + ": this HTML tag could not be converted into a texture:", a.tagName),
                r && r(a, n)
            }
            )
        }
        loadImage(e, t={}, i, r) {
            this.loader.loadImage(e, Object.assign(t, this._texturesOptions), a=>{
                i && i(a)
            }
            , (a,n)=>{
...
`, a),
        ...
        loadVideo(e, t={}, i, r) {
            this.loader.loadVideo(e, Object.assign(t, this._texturesOptions), a=>{
                i && i(a)
            }
            , (a,n)=>{
                this.renderer.production || R(this.type + `: There has been an error:
...
`, a),
    ...
    var nr = new N
      , za = new N
      , yt = class extends Bi {
        constructor(e, t, i="DOMMesh", {widthSegments: r, heightSegments: a, renderOrder: n, depthTest: o, cullFace: l, uniforms: h, vertexShaderID: d, fragmentShaderID: c, vertexShader: p, fragmentShader: f, texturesOptions: u, crossOrigin: g}={}) {
            ...
            this.htmlElement = t,
            (!this.htmlElement || this.htmlElement.length === 0) && (this.renderer.production || R(this.type + ": The HTML element you specified does not currently exists in the DOM")),
        ...
        mouseToPlaneCoords(e) {
            let t = this.scale ? this.scale : za.set(1, 1)
              , i = nr.set((this._boundingRect.document.width - this._boundingRect.document.width * t.x) / 2, (this._boundingRect.document.height - this._boundingRect.document.height * t.y) / 2)
              , r = {
    ...
    ;
    var Ni = class {
        constructor({fov: e=50, near: t=.1, far: i=150, width: r, height: a, pixelRatio: n=1}={}) {
            this.position = new A,
    ...
    var Ye = class {
        ...
        setFromVec3(e) {
            let t = e.x * .5
              ...
              , h = Math.sin(i)
              , d = Math.sin(r);
            return this.axisOrder === "XYZ" ? (this.elements[0] = l * n * o + a * h * d,
            this.elements[1] = a * h * o - l * n * d,
            this.elements[2] = a * n * d + l * h * o,
            this.elements[3] = a * n * o - l * h * d) : this.axisOrder === "YXZ" ? (this.elements[0] = l * n * o + a * h * d,
            this.elements[1] = a * h * o - l * n * d,
            this.elements[2] = a * n * d - l * h * o,
            this.elements[3] = a * n * o + l * h * d) : this.axisOrder === "ZXY" ? (this.elements[0] = l * n * o - a * h * d,
            this.elements[1] = a * h * o + l * n * d,
            this.elements[2] = a * n * d + l * h * o,
            this.elements[3] = a * n * o - l * h * d) : this.axisOrder === "ZYX" ? (this.elements[0] = l * n * o - a * h * d,
            this.elements[1] = a * h * o + l * n * d,
            this.elements[2] = a * n * d - l * h * o,
            this.elements[3] = a * n * o + l * h * d) : this.axisOrder === "YZX" ? (this.elements[0] = l * n * o + a * h * d,
            this.elements[1] = a * h * o + l * n * d,
            this.elements[2] = a * n * d - l * h * o,
            this.elements[3] = a * n * o - l * h * d) : this.axisOrder === "XZY" && (this.elements[0] = l * n * o - a * h * d,
            this.elements[1] = a * h * o - l * n * d,
            this.elements[2] = a * n * d + l * h * o,
    ...
    var Ia = new N
      ...
      , Za = new N
      , be = class extends yt {
        constructor(e, t, {widthSegments: i, heightSegments: r, renderOrder: a, depthTest: n, cullFace: o, uniforms: l, vertexShaderID: h, fragmentShaderID: d, vertexShader: c, fragmentShader: p, texturesOptions: f, crossOrigin: u, alwaysDraw: g=!1, visible: _=!0, transparent: v=!1, drawCheckMargins: x={
            top: 0,
            right: 0,
            bottom: 0,
            left: 0
        }, autoloadSources: T=!0, watchScroll: m=!0, fov: y=50}={}) {
            super(e, t, "Plane", {
                widthSegments: i,
                heightSegments: r,
                renderOrder: a,
        ...
        _initTransformValues() {
            ...
            this.transformOrigin = new A(.5,.5,0),
        ...
        resetPlane(e) {
            ...
            this.updatePosition()) : !e && !this.renderer.production && R(this.type + ": You are trying to reset a plane with a HTML element that does not exist. The old HTML element will be kept instead.")
        }
        removeRenderTarget() {
        ...
        _setWorldTransformOrigin() {
            this._boundingRect.world.transformOrigin = new A((this.transformOrigin.x * 2 - 1) * this._boundingRect.world.width,-(this.transformOrigin.y * 2 - 1) * this._boundingRect.world.height,this.transformOrigin.z)
        }
        _documentToWorldSpace(e) {
            return Ba.set(e.x * this.renderer.pixelRatio / this.renderer._boundingRect.width * this._boundingRect.world.ratios.width, -(e.y * this.renderer.pixelRatio / this.renderer._boundingRect.height) * this._boundingRect.world.ratios.height, e.z)
        }
        _setWorldSizes() {
        ...
        setScale(e) {
            ...
            e.sanitizeNaNValuesWith(this.scale).max(Ia.set(.001, .001)),
        ...
        _getNearPlaneIntersections(e, t, i) {
            ...
            if (i.length === 1)
                i[0] === 0 ? (t[0] = this._getIntersection(t[1], le.set(.95, 1, 0).applyMat4(r)),
                t.push(this._getIntersection(t[3], de.set(-1, -.95, 0).applyMat4(r)))) : i[0] === 1 ? (t[1] = this._getIntersection(t[0], le.set(-.95, 1, 0).applyMat4(r)),
                t.push(this._getIntersection(t[2], de.set(1, -.95, 0).applyMat4(r)))) : i[0] === 2 ? (t[2] = this._getIntersection(t[3], le.set(-.95, -1, 0).applyMat4(r)),
                t.push(this._getIntersection(t[1], de.set(1, .95, 0).applyMat4(r)))) : i[0] === 3 && (t[3] = this._getIntersection(t[2], le.set(.95, -1, 0).applyMat4(r)),
                t.push(this._getIntersection(t[0], de.set(-1, .95, 0).applyMat4(r))));
            else if (i.length === 2)
                i[0] === 0 && i[1] === 1 ? (t[0] = this._getIntersection(t[3], le.set(-1, -.95, 0).applyMat4(r)),
                t[1] = this._getIntersection(t[2], de.set(1, -.95, 0).applyMat4(r))) : i[0] === 1 && i[1] === 2 ? (t[1] = this._getIntersection(t[0], le.set(-.95, 1, 0).applyMat4(r)),
                t[2] = this._getIntersection(t[3], de.set(-.95, -1, 0).applyMat4(r))) : i[0] === 2 && i[1] === 3 ? (t[2] = this._getIntersection(t[1], le.set(1, .95, 0).applyMat4(r)),
                t[3] = this._getIntersection(t[0], de.set(-1, .95, 0).applyMat4(r))) : i[0] === 0 && i[1] === 3 && (t[0] = this._getIntersection(t[1], le.set(.95, 1, 0).applyMat4(r)),
                t[3] = this._getIntersection(t[2], de.set(.95, -1, 0).applyMat4(r)));
            else if (i.length === 3) {
                let a = 0;
                for (let n = 0; n < e.length; n++)
                    i.includes(n) || (a = n);
                t = [t[a]],
                a === 0 ? (t.push(this._getIntersection(t[0], le.set(-.95, 1, 0).applyMat4(r))),
                t.push(this._getIntersection(t[0], de.set(-1, .95, 0).applyMat4(r)))) : a === 1 ? (t.push(this._getIntersection(t[0], le.set(.95, 1, 0).applyMat4(r))),
                t.push(this._getIntersection(t[0], de.set(1, .95, 0).applyMat4(r)))) : a === 2 ? (t.push(this._getIntersection(t[0], le.set(.95, -1, 0).applyMat4(r))),
                t.push(this._getIntersection(t[0], de.set(1, -.95, 0).applyMat4(r)))) : a === 3 && (t.push(this._getIntersection(t[0], le.set(-.95, -1, 0).applyMat4(r))),
                t.push(this._getIntersection(t[0], de.set(-1 - .95, 0).applyMat4(r))))
            } else
                for (let a = 0; a < e.length; a++)
                    t[a][0] = 1e4,
        ...
        mouseToPlaneCoords(e) {
            if (or.setAxisOrder(this.quaternion.axisOrder),
                ...
                return super.mouseToPlaneCoords(e);
            {
                ...
                if (Math.abs(o) >= 1e-4) {
                    let l = this._matrices.world.matrix.getInverse().multiply(this.camera.viewMatrix)
                      ...
                      , d = qa.set(this._translation.x - h.x, this._translation.y - h.y, this._translation.z - h.z);
                    d.applyQuat(this.quaternion),
                    h.add(d);
                    let c = a.dot(h.clone().sub(i)) / o;
                    n.copy(i.add(r.multiplyScalar(c))),
                    n.applyMat4(l)
                } else
    ...
    ;
    var Se = class {
        constructor(e, {shaderPass: t, depth: i=!1, clear: r=!0, minWidth: a=1024, minHeight: n=1024, texturesOptions: o={}}={}) {
        ...
        _createFrameBuffer() {
            ...
            this.textures[0]._restoreContext()) : new ae(this.renderer,this._texturesOptions).addParent(this),
        ...
        remove() {
            if (this._shaderPass) {
                this.renderer.production || R(this.type + ": You're trying to remove a RenderTarget attached to a ShaderPass. You should remove that ShaderPass instead:", this._shaderPass);
                return
            }
            this._dispose(),
    ...
    var vt = class extends yt {
        constructor(e, {widthSegments: t, heightSegments: i, renderOrder: r, depthTest: a, cullFace: n, uniforms: o, vertexShaderID: l, fragmentShaderID: h, vertexShader: d, fragmentShader: c, texturesOptions: p, crossOrigin: f, depth: u=!1, clear: g=!0, renderTarget: _}={}) {
            t = 1,
            i = 1,
            n = "back",
        ...
        _startDrawing() {
            ...
            this.renderer.state.scenePassIndex++) : this.renderer.bindFrameBuffer(null) : this.renderer.state.scenePassIndex === null && this.renderer.bindFrameBuffer(null),
    ...
    var Xt = class extends be {
        constructor(e, t, {sampler: i="uPingPongTexture", widthSegments: r, heightSegments: a, renderOrder: n, depthTest: o, cullFace: l, uniforms: h, vertexShaderID: d, fragmentShaderID: c, vertexShader: p, fragmentShader: f, texturesOptions: u, crossOrigin: g, alwaysDraw: _, visible: v, transparent: x, drawCheckMargins: T, autoloadSources: m, watchScroll: y, fov: w}={}) {
            o = !1,
            m = !1,
            super(e, t, {
                widthSegments: r,
            ...
            this.renderer.scene.addPlane(this),
            this.readPass = new Se(e,{
                depth: !1,
                clear: !1,
                texturesOptions: u
            }),
            this.writePass = new Se(e,{
                depth: !1,
                clear: !1,
                texturesOptions: u
            });
            let b = this.createTexture({
                sampler: i
            })
              , P = 0;
            this.readPass.getTexture().onSourceUploaded(()=>{
                P++,
                this._checkIfReady(P)
            }
            ),
    ...
    ;
    var Yt = class {
        constructor({plane: e, textElement: t, skipFontLoading: i=!1, verticalAlign: r="top", allowedLineEndSpace: a=.5, fillType: n="fill", sampler: o="uTextTexture", texturesOptions: l={}, resolution: h=1, onBeforeWordMeasuring: d=()=>{}
        ...
        , onAfterWordWriting: f=()=>{}
            ...
            ,
            this.plane.onAfterResize = g=>(g && (this._onAfterResizeCallback = g),
            this.plane)
        }
        setCanvasSize() {
            ...
            this.content.innerBoundingRect = {
                ...
                top: parseFloat(this.content.style.paddingTop) + (this.content.boundingRect.top - e.top / this.pixelRatio),
                left: parseFloat(this.content.style.paddingLeft) + (this.content.boundingRect.left - e.left / this.pixelRatio)
            },
        ...
        loadFont() {
            this.skipFontLoading ? this.content.fontLoaded = !0 : document.fonts.load(this.content.style.fontStyle + " " + this.content.style.fontWeight + " 1em " + this.content.style.fontFamily).then(()=>{
                this.content.fontLoaded = !0,
                this.texture && !this.content.firstWrite && (this.plane.resize(),
                this.writeTexture())
            }
            )
        }
        writeTexture(e=!0) {
            ...
            let n = i / r
              , o = r * .1 + (n - 1) * r * .5;
            navigator.userAgent.indexOf("Safari") !== -1 && navigator.userAgent.indexOf("Chrome") === -1 && (o = (n - 1.4) * r / 2);
            let l = {
                x: t,
                y: this.content.innerBoundingRect.top + o
            };
            (e || !this.lines) && (this.lines = [],
            this.content.words.forEach((c,p)=>{
                this.content.style.textTransform === "uppercase" ? c.word = c.word.toUpperCase() : this.content.style.textTransform === "lowercase" && (c.word = c.word.toLowerCase()),
                ...
                (p > 0 && l.x + f > this.content.innerBoundingRect.width + this.content.innerBoundingRect.left + a * this.allowedLineEndSpace || c.word === "") && (l.x = t,
                l.y += i),
            ...
            this.content.verticalAlign === "center" ? h.y = (this.content.innerBoundingRect.height - d) * .5 - o * .5 : this.content.verticalAlign === "bottom" && (h.y = this.content.innerBoundingRect.height - d + o * .5),
            this.lines.forEach((c,p)=>{
                c.forEach(f=>{
                    let u = c[0].position.x + c[c.length - 1].position.x + c[c.length - 1].wordWidth - t;
                    this.content.style.textAlign === "right" || this.content.style.textAlign === "end" ? h.x = this.content.innerBoundingRect.right - u : this.content.style.textAlign === "center" && (h.x = (this.content.innerBoundingRect.right - u) / 2),
                    this.onBeforeWordWriting && this.onBeforeWordWriting(this.context, f, {
                        left: f.position.x + h.x,
                        top: f.position.y + h.y,
                        right: f.position.x + h.x + f.wordWidth,
                        bottom: f.position.y + h.y + r
                    }, this.content.style, p),
                    this.content.style.fillType === "stroke" ? (this.context.miterLimit = 2,
                    this.context.strokeText(f.word, f.position.x + h.x, f.position.y + h.y)) : this.context.fillText(f.word, f.position.x + h.x, f.position.y + h.y),
                    this.onAfterWordWriting && this.onAfterWordWriting(this.context, f, h, this.content.style, p)
                }
                )
            }
            ),
        ...
        resize() {
            this.texture && (this.setCanvasSize(),
            this.writeTexture())
        }
        dispose() {
            this.content = {},
...
`
    ...
    var Gi = class {
        constructor({container: e="canvas", production: t=!1, width: i=0, height: r=0, smoothScroll: a, isMobile: n, onWebGLLayerError: o=()=>{}
        , onWebGLSuccess: l=()=>{}
        }) {
            this.production = t,
            this.smoothScroll = a,
        ...
        onScroll(e) {
            ...
            this.scrollPass && e.velocity && (this.scrollPass.uniforms.scrollEffect.value = Math.max(-30, Math.min(30, e.velocity / 2)))
        }
        onMouseMove(e) {
            if (this.ripples) {
                ...
                this.mouse.last.x === 0 && this.mouse.last.y === 0 && this.mouse.current.x === 0 && this.mouse.current.y === 0 && (this.mouse.updateVelocity = !1),
                this.mouse.current.set(e.x, e.y);
                let t = this.ripples.mouseToPlaneCoords(this.mouse.current);
                if (this.ripples.uniforms.mousePosition.value = t,
                this.mouse.updateVelocity) {
                    let i = (performance || Date).now()
                      , r = Math.max(14, i - this.mouse.lastTime);
                    this.mouse.lastTime = i,
                    this.mouse.velocity.set((this.mouse.current.x - this.mouse.last.x) / r, (this.mouse.current.y - this.mouse.last.y) / r)
                }
            }
        }
        addRipples() {
            this.ripples = new Xt(this.curtains,document.getElementById("ripples"),{
                ...
                uniforms: {
                    ...
                    dissipation: {
                        name: "uDissipation",
                        type: "1f",
                        value: this.isPortrait ? .985 : .9875
                    }
                }
            }),
            this.ripples.onRender(()=>{
                this.mouse.velocity.set(this.curtains.lerp(this.mouse.velocity.x, 0, .05), this.curtains.lerp(this.mouse.velocity.y, 0, .1)),
                ...
                this.ripples.uniforms.dissipation.value = this.isPortrait ? .985 : .9875
            }
            )
        }
        addRenderPasses() {
            ...
            this.scrollPass.onRender(()=>{
                this.smoothScroll || (this.scroll.lastValue = this.scroll.value,
                ...
                this.scroll.effect = this.curtains.lerp(this.scroll.effect, this.scroll.delta, .05),
            ...
            this.curtains.isWebGL2() && (t.vertexShader = Tr,
            t.fragmentShader = Pr),
            this.renderPass = new vt(this.curtains,t),
            this.renderPass.onRender(()=>{
        ...
        removePlanes() {
            this.curtains.planes.forEach(e=>{
                e.type !== "PingPongPlane" && e.userData.name !== "homeLink" && (e.userData.tween && (e.userData.tween.kill(),
                e.userData.tween = null),
                e.userData.mouseEl && e.userData.mouseEnter && e.userData.mouseEl.removeEventListener("mouseenter", e.userData.mouseEnter),
                e.userData.mouseEl && e.userData.mouseLeave && e.userData.mouseEl.removeEventListener("mouseleave", e.userData.mouseLeave),
                e.userData.links && e.userData.links.forEach(t=>{
        ...
        addHeaderLinkPlanes() {
            document.querySelectorAll("#header .header-plane").forEach(e=>{
                ...
                let r = (n,o,l)=>{
                    ...
                    n.lineWidth = 2,
                    i.userData.isHovered && (n.beginPath(),
                ...
                t && !this.isMobile && (e.addEventListener("mouseenter", ()=>{
                    i.userData.isHovered = !0,
                    a.writeTexture(!1)
                }
                ),
        ...
        addSingleTextPlane(e) {
            ...
            n && e.querySelectorAll("a").forEach(f=>{
                let u = f.textContent;
                f.innerText = u.replace(/[\n\r]+|[\s]{2,}/g, " ").trim().split(" ").join('"')
            }
            );
            let d = ()=>{}
            ;
            if (n) {
                let p = e.querySelectorAll("a");
                h.userData.links = [],
                p.forEach(f=>{
                    let u = {
                        word: f.innerText,
                ...
                d = (f,u,g)=>{
                    ...
                    _ && (f.strokeStyle = this.textColor,
                    f.lineWidth = 2,
                    _.isHovered || (f.beginPath(),
            ...
            o && (h.userData.isHovered = !1,
            h.userData.mouseEl = e,
            this.isMobile || (h.userData.mouseEnter = ()=>{
            ...
            d = (p,f,u)=>{
                ...
                h.userData.isHovered && (p.strokeStyle = this.textColor,
                p.lineWidth = 2,
                p.beginPath(),
            ...
            let c = new Yt({
                ...
                resolution: 1.5,
                skipFontLoading: !0,
                allowedLineEndSpace: l ? 2 : .5,
                onBeforeWordWriting: d
            });
            if (h.userData.textTexture = c,
            a) {
                ...
                let u = ()=>{
                    if (h.userData.refParallaxPlane)
                        if (this.isPortrait)
                            h.relativeTranslation.y !== 0 && (h.relativeTranslation.y = 0);
                        else {
        ...
        addSingleHRPlane(e) {
            let t = e.classList.contains("site-list-separator") || e.classList.contains("project-separator") ? .5 : 1
              , i = new be(this.curtains,e,{
                vertexShader: cr,
                fragmentShader: fr,
                uniforms: {
            ...
            i.setRenderTarget(this.scrollTarget),
            i.userData.fadeDuration = 1.5
        }
        addRegularPlanes() {
        ...
        addSingleRegularPlane(e) {
            ...
            n.userData.mouseEnter = ()=>{
                ...
                n.userData.tween = ee.to(o, {
                    ...
                    ease: "back.out",
                    onUpdate: ()=>{
                        this.isPortrait || (n.uniforms.opacity.value = o.opacity,
            ...
            n.onAfterResize(()=>{
                this.isPortrait ? (n.userData.isHovered = !1,
                n.uniforms.opacity.value = 1) : (n.userData.isHovered = !1,
                n.uniforms.opacity.value = n.userData.minOpacity)
            }
            ))
        }
        addVideoPlanes() {
        ...
        addSingleVideoPlane(e) {
            ...
            t.loadVideo(e.querySelector("img").getAttribute("data-video"), {
                sampler: "planeTexture"
            }),
            t.onLoading(i=>{
                i.sourceType === "video" && (i.onSourceUploaded(()=>{
                    t.uniforms.videoStarted.value = 1
                }
                ),
                t.userData.videoLoaded = !0,
                t.userData.videoLoaded && t.userData.shown && (t.userData.playPromise = i.source.play(),
                t.userData.canPlay = !0,
                t.userData.playPromise !== void 0 && t.userData.playPromise.catch(()=>{
                    t.uniforms.videoStarted.value = 0,
                    t.userData.canPlay = !1
                }
                )))
            }
            ).onReEnterView(()=>{
                t.userData.videoLoaded && t.userData.shown && t.textures[1].source && t.textures[1].source.paused && t.userData.canPlay && t.textures[1].source.play()
            }
            ).onLeaveView(()=>{
                t.userData.videoLoaded && t.userData.shown && t.textures[1].source && !t.textures[1].source.paused && t.userData.canPlay && t.textures[1].source.pause()
            }
            )
        }
    }
    ...
    "use strict";
    var Hi = class {
        constructor({container: e, inertia: t=.1, threshold: i=.5, useRaf: r=!1}={}) {
            if (this.container = e,
            !this.container) {
                console.warn("Can't init SmoothScroll class because the container passed does not exist:", e);
                return
            }
            this.inertia = t,
            this.threshold = i,
        ...
        init() {
            ...
            this.scroll.current !== 0 && (this.scrollTo(this.scroll.current),
            setTimeout(()=>{
                this.emitScroll()
            }
            , 0)),
        ...
        render() {
            ...
            Math.abs(this.scroll.current - this.scroll.target) >= this.threshold ? (this._isScrolling = !0,
            this.updatePosition(),
            this.emitScroll()) : this._isScrolling && (this._isScrolling = !1,
    ...
    ;
    var Rr = class {
        constructor({production: e=!1, analyticsID: t, appContainer: i, webglContainer: r, transitionDuration: a=1e3}) {
            this.production = e,
            this.state = {
                loader: {
                ...
                fonts: {
                    loaded: 0,
                    list: ['normal 400 1em "MonumentExtended Regular", Arial, sans-serif', 'normal 400 1em "MonumentExtended UltraBold", Arial, sans-serif', 'normal 400 1em "Swiss", serif']
                }
            },
            this.checkPerf(),
        ...
        checkPerf() {
            ...
            let e = (performance || Date).now()
              , t = [];
            for (let a = 0; a < 2e4; a++)
                t = Math.pow(Math.sin(Math.random()), 2);
            let i = (performance || Date).now() - e;
            i < 7 ? this.perf += 1 : i < 14 ? this.perf += 2 : i < 22 ? this.perf += 3 : this.perf += 4;
            let r = window.matchMedia("(prefers-reduced-motion: reduce");
            window.location.href.indexOf("no-motion") !== -1 ? r = !1 : window.location.href.indexOf("no-webgl") !== -1 && (this.perf = this.state.webglPerfThreshold + 1),
            !r || r.matches ? (this.perf = 6,
            document.body.classList.add("no-motion")) : this.perf > this.state.webglPerfThreshold && document.body.classList.add("reduced-motion")
        }
        startServiceWorker() {
            "serviceWorker"in navigator && navigator.serviceWorker.register("/sw.js")
        }
        initAnalytics() {
            this.analyticsID && this.production && (window.dataLayer = window.dataLayer || [],
            this.gtag = function() {
            ...
            this.perf >= 6 ? this.gtag("event", "load", {
                event_category: "Version displayed",
                event_label: "No motion",
                non_interaction: !0
            }) : this.perf > this.state.webglPerfThreshold && this.gtag("event", "load", {
                event_category: "Version displayed",
        ...
        onMouseMove(e) {
            e.targetTouches ? this.store.mouse.current = {
        ...
        onWindowLoad() {
            ...
            !this.state.isMobile && this.perf < 6 ? (this.smoothScroll = new Hi({
            ...
            window.addEventListener("keyup", e=>{
                if ((e.keyCode ? e.keyCode : e.which) === 9) {
                    ...
                    i.classList.contains("header-plane") || this.smoothScroll.scrollTo(i.getBoundingClientRect().top + this.store.scroll.y - 100)
                }
            }
            ...
            this.perf <= this.state.webglPerfThreshold && (window.addEventListener("mousemove", this.onMouseMove.bind(this), !1),
        ...
        onCurtainsReady() {
            this.state.windowLoaded && this.state.hasWebgl && !this.state.webglStarted && (this.addEvents({
            ...
            "requestIdleCallback"in window ? requestIdleCallback(()=>{
                // this.state.loader.el.classList.remove("shown"),
        ...
        setNameSpace() {
            this.state.namespace = document.getElementById("content").getAttribute("data-namespace") || "home"
        }
        startRouting() {
        ...
        onPageLoad() {
            ...
            !this.state.loader.loaded) {
                let e = (performance || Date).now()
                  , t = e - this.state.loader.startTs > this.state.loader.minDuration ? 0 : this.state.loader.minDuration - (e - this.state.loader.startTs);
                setTimeout(()=>{
                    this.perf > this.state.webglPerfThreshold && (this.state.loader.el.classList.remove("shown"),
                    this.startMainObserver())
                }
                , t)
            }
            ...
            this.state.scrollTopButton && this.state.scrollTopButton.addEventListener("click", this.scrollToTop.bind(this), !1),
            this.webglLayer || document.body.classList.remove("page-transition")
        }
        afterPageLoad() {
            this.webglLayer && (this.webglLayer.renderPass.uniforms.transitionDirection.value = -1,
        ...
        beforePageUnload(e, t) {
            ...
            this.observers.main && this.state.hasObserver && this.observers.main.els.forEach(i=>{
                this.observers.main.unobserveEl(i.el)
            }
            ),
            this.state.scrollTopButton && this.state.scrollTopButton.removeEventListener("click", this.scrollToTop.bind(this), !1)
        }
        onPageUnload() {
            for (let e = 0; e < this.store.pageTweens.length; e++)
                this.store.pageTweens[e].kill(),
                this.store.pageTweens[e] = null;
        ...
        scrollToTop() {
            if (this.perf < 6) {
                ...
                window.scrollTo(0, 0);
            this.state.scrollTopButton && (this.state.scrollTopButton.classList.add("clicked"),
            setTimeout(()=>{
                this.state.scrollTopButton && (this.state.scrollTopButton.classList.remove("clicked"),
                this.state.scrollTopButton.blur())
            }
            , 1e3))
        }
        setObserver({name: e, root: t, rootMargin: i, threshold: r=[0, .25, .5, .75, 1]}) {
            this.observers[e || "observer-" + this.observers.length] = new Mi({
                threshold: r,
                root: t,
                rootMargin: i
            }).onError(()=>{
                this.state.hasObserver = !1,
                this.handleObserverError()
            }
            )
        }
        handleObserverError() {
            this.webglLayer ? this.webglLayer.curtains.planes.forEach(e=>{
        ...
        startMainObserver() {
            this.observers.main && this.observers.main.observe({
                ...
                onBeforeElVisible: e=>{
                    ...
                    e.el.classList.contains("site-list-separator") ? e.stagger = 0 : e.el.closest(".site-list-right-content") || e.el.closest(".site-list-left-content") ? e.stagger = 50 : e.el.classList.contains("text-plane-is-link") && (e.stagger = 150),
                    e.el.hasAttribute("data-stagger") && (e.stagger = parseInt(e.el.getAttribute("data-stagger")))
                }
                ,
                onElVisible: e=>{
                    if (this.webglLayer) {
                        let t = this.webglLayer.curtains && this.webglLayer.curtains.planes.find(i=>i.htmlElement.isSameNode(e.el));
                        ...
                        let t = e.el.classList.contains("main-title-text")
                          ...
                          , a = e.el.hasAttribute("data-min-opacity") ? e.el.getAttribute("data-min-opacity") : 1
                          ...
                          , o = i ? ee.fromTo(e.el, {
                            ...
                            onComplete: ()=>{
                                e.el.classList.contains("project-plane") ? e.el.classList.add("project-plane-shown") : e.el.classList.contains("header-plane") && e.el.classList.add("header-el-shown")
                            }
                        });
